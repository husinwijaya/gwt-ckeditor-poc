...
this.markForRedraw()}
,isc.A.showMonth=function isc_DateChooser_showMonth(_1){this.month=_1;if(this.monthMenu)this.monthMenu.hide();this.markForRedraw()}
...
,isc.A.setMinValue=function isc_Slider_setMinValue(_1){this.minValue=_1;if(this.$50)this.$50.setContents(_1);this.setValue(this.minValue)}
,isc.A.setMaxValue=function isc_Slider_setMaxValue(_1){this.maxValue=_1;if(this.$52)this.$52.setContents(_1);this.setValue(this.minValue)}
...
,isc.A.destroy=function isc_DynamicForm_destroy(){if(this.valuesManager)this.valuesManager.removeMember(this);this.$10k(this.items);this.Super("destroy",arguments)}
...
this.$6l=_12}}
if(_3)this.items=_1
else this.items.addListAt(_1,_2);if(!_4)this.setItemValues(null,false,true,_1);if(_8)this.encoding=isc.DynamicForm.MULTIPART_ENCODING;for(var i=0;i<_7.length;i++){var _15=_7[i],_16=_15.sectionExpanded;if(_16&&(!_10||(this.$6l==_15))){_15.expandSection()}else{_15.collapseSection()}}
...
,isc.A.moved=function isc_DynamicForm_moved(_1,_2,_3,_4){this.invokeSuper(isc.DynamicForm,"moved",_1,_2,_3,_4);this.itemsMoved()}
,isc.A.parentMoved=function isc_DynamicForm_parentMoved(_1,_2,_3,_4){this.invokeSuper(isc.DynamicForm,"parentMoved",_1,_2,_3,_4);this.itemsMoved()}
...
,isc.A.itemsVisibilityChanged=function isc_DynamicForm_itemsVisibilityChanged(){var _1=this.getItems();if(!_1)return;for(var i=0;i<_1.length;i++){_1[i].visibilityChanged()}}
...
,isc.A.rememberValues=function isc_DynamicForm_rememberValues(){var _1=this.getValues(),_2=this.$10s={};this.$10t=[];var _3="__ref";for(var _4 in _1){if(isc.isA.Function(_1[_4]))continue;if(_4==_3)continue;if(isc.isA.Date(_1[_4])){_2[_4]=new Date();_2[_4].setTime(_1[_4].getTime())}else{_2[_4]=_1[_4]}
...
,isc.A.valuesHaveChanged=function isc_DynamicForm_valuesHaveChanged(_1){var _2=this.getValues(),_3=this.$10s,_4=false,_5={};if(!isc.isAn.Object(_3))_3={};for(var _6 in _2){if(isc.isA.Function(_2[_6]))continue;var _7=this.getItem(_6);if(_7!=null){_4=!_7.compareValues(_2[_6],_3[_6])}else{_4=!isc.DynamicForm.compareValues(_2[_6],_3[_6])}
if(_4){if(!_1)return true;_5[_6]=_2[_6]}}
return(_1?_5:_4)}
...
,isc.A.getValuesAsCriteria=function isc_DynamicForm_getValuesAsCriteria(_1,_2,_3){if(_1==null){_1=(this.operator!="and")||this.getItems().map("hasAdvancedCriteria").contains(true)||(this.$76u!=null)}
if(!_1){var _4=this.$76v();if(_3)return _4;return isc.DataSource.filterCriteriaForFormValues(_4)}
var _5=this.$76u?isc.clone(this.$76u):{operator:this.operator,_constructor:"AdvancedCriteria",criteria:[]};var _6=this.$76v(true,_2);_5.criteria.addList(_6);return _5}
...
_1.$10x()}
,isc.A.$10w=function isc_DynamicForm__saveValue(_1,_2){isc.DynamicForm.$70n(_1,_2,this.values);if(!this.selectionComponent&&this.valuesManager!=null){if(isc.isA.ValuesManager(this.valuesManager)&&this.valuesManager.members&&this.valuesManager.members.contains(this))
{this.valuesManager.$10y(_1,_2,this)}}}
,isc.A.clearItemValue=function isc_DynamicForm_clearItemValue(_1){var _2=_1.getDataPath()||_1.getFieldName();isc.DynamicForm.$70m(_2,this.values);if(!this.selectionComponent&&this.valuesManager){this.valuesManager.$10z(_2,this)}}
,isc.A.$10r=function isc_DynamicForm__saveValues(_1){this.values=_1;if(!this.selectionComponent&&this.valuesManager!=null){var _2=isc.getKeys(this.values);for(var i in _1){this.valuesManager.$10y(i,_1[i],this);_2.remove(i)}
...
,isc.A.$100=function isc_DynamicForm__sectionExpanding(_1){if(this.sectionVisibilityMode=="mutex"&&this.$6l&&this.$6l!=_1)
{this.$6l.collapseSection()}
this.$6l=_1}
,isc.A.$101=function isc_DynamicForm__sectionCollapsing(_1){}
,isc.A.getErrors=function isc_DynamicForm_getErrors(){return this.errors}
,isc.A.getFieldErrors=function isc_DynamicForm_getFieldErrors(_1){if(!this.errors)return null;var _2;if(isc.isA.FormItem(_1)){var _3=_1;_1=_3.getFieldName();_2=_3.getDataPath()}
var _4=this.errors[_1];if(isc.isA.String(_4)||isc.isAn.Array(_4)){return _4}
if(_2!=null){var _4=this.errors[_2];if(isc.isA.String(_4)||isc.isAn.Array(_4))return _4}
return null}
...
,isc.A.clearFieldErrors=function isc_DynamicForm_clearFieldErrors(_1,_2){if(this.errors==null)return;if(!this.errors[_1])return;delete this.errors[_1];if(_2){this.showFieldErrors(_1)}}
...
,isc.A.$11a=function isc_DynamicForm__itemsCleared(){var _1=this.items;for(var i=0;i<_1.length;i++){if(_1[i].isDrawn())_1[i].cleared()}}
...
_4=_4||this.items;for(var _7=0;_7<_4.length;_7++){var _8=_4[_7],_9=_8.getFieldName(),_10=_8.getDataPath(),_11=_8.isSetToDefaultValue(),_12;if(_10){var _13=_10.split(isc.slash),_14=_1;for(var i=0;i<_13.length-1;i++){_14=_14[_13[i]];if(_14==null)break}
if(_14!=null)_12=_14[_13.last()]}else if(_9)_12=_1[_9];if(_2&&isc.CanvasItem&&isc.isA.CanvasItem(_8)&&!_8.$11d())
{continue}
var _16,_17=((!_9&&!_10)||_12===_16);var _18=null;if(_3&&_17&&_8.value!=null){_18=_8.value;if(_18!=_8._value)_11=false}
var _19=null;if(_17&&_6!=null){for(var i=0;i<_6.length;i++){if(_8.canEditCriterion(_6[i])){_17=false;_19=_6[i];_6.removeAt(i);if(_6.length==0)delete this.$76u;break}}}
if(_8.shouldSaveValue==false){if(!_17){this.logInfo("DynamicForm.setValues() passed a value for '"+_8[this.fieldIdProperty]+"'."+" The corresponding form item was declared with 'shouldSaveValue' set to "+" false to exclude its value from the form's values object."+" Setting 'shouldSaveValue' to true for this item."+"\n[To avoid seeing this message in the future, set 'shouldSaveValue'"+" to true for any form items whose values are to be managed via "+" form.setValues() / form.getValues().]")
_8.shouldSaveValue=true}else{var _20=(_11?null:_8._value);if(_18!=null)_20=_18;_8.setValue(_20,(_11?false:_2));continue}}
if(_18!=null){_17=false;_12=_18}
if(_17||(_19==null&&_5&&_11)){var _21;if(!_3)_8.clearValue();else if(_3&&_11&&_8._value!==_21){_8.saveValue(_8._value,true)}}else{if(_19!=null){_8.setCriterion(_19)}else{_8.setValue(_12,true)}}}}
...
_1.append(this.$9w);for(var _21=0;_21<_13.length;_21++){if(!isc.isA.Number(_13[_21])){_1.append(this.$9x.join(isc.emptyString),this.$9y)}else{var _18=_13[_21];_18-=(this.cellSpacing!=null?(2*this.cellSpacing):0);this.$9x[3]=(isc.FormItem?isc.FormItem.getPrototype().baseStyle:null);var _23=isc.Browser.isIE?1:0,_24=this.$9x.join(isc.emptyString);_1.append(_24,this.fixedColWidths?isc.Canvas.spacerHTML(_18,_23):null,this.$9y)}}
...
,isc.A.getAbsPosHTML=function isc_DynamicForm_getAbsPosHTML(){var _1=isc.SB.create();for(var _2=0,_3=this.items.length;_2<_3;_2++){var _4=this.items[_2];if(!_4)continue;_4.$10x();if(!_4.visible)continue;_1.append(_4.getStandaloneItemHTML(_4.getValue()))}
return _1.release()}
...
,isc.A.validate=function isc_DynamicForm_validate(_1,_2,_3,_4){if(this.disableValidation)return true;if(this.dataSource&&this.dataSource.useLocalValidators!=null&&this.useLocalValidators==false)return true;var _5=this.hasErrors(),_6=false,_7=null,_8=this.getForm(),_9=false;var _10={},_11={},_12=this.getValues(),_13=(_1&&!_2&&this.dataSource)?isc.addProperties({},this.getDataSource().getFields()):null;var _14={unknownErrorMessage:this.unknownErrorMessage,serverValidationMode:"full"};if(_3)
_14.typeValidationsOnly=_3;for(var _15=0;_15<this.items.length;_15++){var _16=false,_17=this.items[_15],_18=_17.getFieldName(),_19=_17.getDataPath(),_20=_17.getValue(),_21=!_17.visible||isc.isA.HiddenItem(_17);if(_21&&!_1)continue;if(_17.validators!=null){if(!isc.isAn.Array(_17.validators)){_17.validators=[_17.validators]}
var _22=this.validateField(_17,_17.validators,_20,_12,_14);if(_22!=null){if(_22.errors!=null){_16=this.addValidationError(_10,_18||_19,_22.errors);if(_16)_6=true}
if(_22.resultingValue!=null){_20=_22.resultingValue;if(_18){_12[_18]=_20}
_9=true}}}
if(_21){if(_16)_11[_18||_19]=_10[_18||_19]}else if(_7==null&&_6)_7=_17;if(_13)delete _13[_18]}
if(_13){_14.dontValidateNullValues=true;delete _14.typeValidationsOnly;for(var i in _13){var _24=_13[i],_25=i,_26=_24.validators,_20=_12[_25];if(_26!=null){var _20=_12[_25];var _22=this.validateField(_24,_26,_20,_12,_14);if(_22!=null&&_22.errors!=null){this.addValidationError(_10,_25,_22.errors)}}
if(_10[_25]!=null)_11[_25]=_10[_25]}}
if(_6)this.logInfo("Validation errors: "+isc.Log.echoAll(_10));if(_4)return(_6?_10:true);this.setErrors(_10);if(_9){this.setItemValues(_12);for(var _27 in _12){if(this.getItem(_27)==null)this.$10w(_27,_12[_27])}}
...
,isc.A.showErrors=function isc_DynamicForm_showErrors(_1,_2){var _3;if(_2===_3)_2=this.getHiddenErrors();if(_1===_3)_1=this.getErrors();if(_1&&!this.showInlineErrors&&(!this.$52o||this.$52o.destroyed))
...
return(_1?_2:null)}
,isc.A.showFieldErrors=function isc_DynamicForm_showFieldErrors(_1){return this.showErrors()}
...
,isc.A.setFocus=function isc_DynamicForm_setFocus(_1){if(!this.$vl())return;var _2=this.isVisible();if(_1){var _3=this.getFocusSubItem();if(_3==null){var _4=this.getItems();for(var i=0;i<_4.length;i++){var _6=_4[i];if(_6.$kk()&&_6.isDrawn()&&_6.isVisible()&&!_6.isDisabled())
{_3=_6;break}}}
...
,isc.A.focusInItem=function isc_DynamicForm_focusInItem(_1){if(_1!=null){var _2=this.getItem(_1)}else{var _2=this.getFocusSubItem()}
if(!_2){if(_1!=null)this.logWarn("couldn't find focus item: "+_1);return}
...
,isc.A.handleDoubleClick=function isc_DynamicForm_handleDoubleClick(_1,_2){var _3=this.$ne(_1);if(_3&&_3.item){var _4=_3.item;if(_3.inactiveContext){return this.bubbleInactiveEditorEvent(_4,"doubleClick",_3)}else if(_3.overTitle){return this.bubbleItemHandler(_4,"handleTitleDoubleClick",_4)}else{var _5=(_3.overElement||_3.overTextBox||_3.overControlTable);if(_3.overIcon){if(_4.$116(_3.overIcon)==false)return false;var _6=_4.getIcon(_3.overIcon);if(_6&&_6.writeIntoItem)_5=true}
...
);isc.evalBoundary;isc.B.push(isc.A.adjustDragLinePosition=function isc_DynamicForm_adjustDragLinePosition(_1,_2,_3){var _4=this.items.$8j,_5=this.items.indexOf(_2),_6,_7,_8;for(var i=0;i<_4.length;i++){if(_4[i].indexOf(_5)!=-1){_6=i;_7=_4[i].indexOf(_5);_8=_4[i].lastIndexOf(_5);break}}
...
);isc.B._maxIndex=isc.C+225;isc.A=isc.DynamicForm;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.defaultFieldType="text";isc.A.$12a="link";isc.A.$gx="text";isc.A.$12b="select";isc.A.$12c="checkbox";isc.A.$12d="staticText";isc.A.$g2="boolean";isc.A.$12e="binary";isc.A.$12f="blob";isc.A.$52w="multifile";isc.A.$12g="multiupload";isc.A.$9i="upload";isc.A.$52x="file";isc.A.$51x="base64Binary";isc.A.$12h="enum";isc.A.$12i="CycleItem";isc.A.$12j="selectOther";isc.A.$12k="relation";isc.A.$67f="NestedEditorItem";isc.A.$67g="NestedListEditorItem";isc.A.$677="imageFile";isc.A.$678="ViewFileItem";isc.A.$77j="section";isc.A.$77k="SectionItem";isc.A.$77l="button";isc.A.$77m="ButtonItem";isc.A.$450="id";isc.B.push(isc.A.getEditorType=function isc_c_DynamicForm_getEditorType(_1,_2){if(_1._constructor==isc.FormItem.Class)_1._constructor=null;var _3=_2.getDataSource();var _4=this.defaultFieldType,_5=_1.editorType||_1.formItemType||_1._constructor||_1.type||_4;if(_1.editorType||_1.formItemType||_1._constructor)return _5;if(_5==this.$12a){if(!this.canEditField(_1,_2))_5=this.$12a;else _5=this.$gx}else if(!this.canEditField(_1,_2)){if(_5==this.$12e||_5==this.$52x||_5==this.$677)
_5=this.$678;else if(_5!=this.$77j&&_5!=this.$77k&&_5!=this.$77l&&_5!=this.$77m)
{_5=this.$12d}}else if(_5==this.$g2){var _6=_1.valueMap;if(!isc.isAn.Array(_6)&&isc.isAn.Object(_6))_5=this.$12b;else _5=this.$12c}else if(_5==this.$12e||_5==this.$12f||_5==this.$52x||_5==this.$677)
...
return _2}
,isc.A.destroy=function isc_FormItem_destroy(){if(this.isDrawn())this.cleared();var _1=this.pickList;this.pickList=null;if(_1!=null){if(_1.formItem==this)delete _1.formItem;if(_1.isVisible())_1.hide();if(!this.reusePickList())_1.destroy()}
...
,isc.A.getInnerHeight=function isc_FormItem_getInnerHeight(){var _1=this.containerWidget;if(this.$11e())return this.$11p(this.height,true);if(this.$8t){var _2=this.$8t[1];if(!isc.isA.Number(_2))return _2;if(this.$142()){_2-=this.$140()}
return _2}
return this.getHeight()}
,isc.A.getInnerWidth=function isc_FormItem_getInnerWidth(_1){var _2=this.containerWidget;if(this.$11e())return this.$11p(this.width);var _3=this.$8t?this.$8t[0]:this.width;if(!isc.isA.Number(_3))return _3;if(this.$142()){_3-=this.$141()}
return _3}
...
,isc.A.getTextBoxCellCSS=function isc_FormItem_getTextBoxCellCSS(){return this.textBoxCellCSS}
...
return this.$150}
);isc.evalBoundary;isc.B.push(isc.A.getElementHTML=function isc_FormItem_getElementHTML(_1,_2){var _3=isc.SB.create(),_4=this.$15m();var _5=this.$kk(),_6,_7;if(_5){var _8=this.$154(),_9=this.isDisabled()?null:this.accessKey;if(_4){_7=isc.Canvas.getFocusProxyString(this.getID(),false,0,0,this.getTextBoxWidth(),this.getTextBoxHeight(),this.isVisible(),!this.isDisabled(),_8,_9,false)}else{var _10=isc.SB.create();if(_9!=null)_10.append(this.$14e,_9,this.$ob);_10.append(this.$14f,_8,this.$ob);_6=_10.release()}}
...
return _8}
,isc.A.getErrorIconHTML=function isc_FormItem_getErrorIconHTML(_1){this.$79u=_1;var _2=this.getErrorIconId();return this.$157(_2,this.errorIconWidth,this.errorIconHeight,"top",0,null,null,this.form.getImgURL(this.errorIconSrc),this.getID(),_2,null,true,isc.DynamicForm.$89+"='"+this.getID()+"' "+isc.DynamicForm.$9a+"='"+_2+"'")}
...
,isc.A.getIconsHTML=function isc_FormItem_getIconsHTML(){if(!this.showIcons||this.icons==null)return"";var _1=this.$16j(true);if(this.showIconsOnFocus&&!_1){this.hideAllIcons();return""}
var _2=isc.SB.create(),_3=false;for(var i=0;i<this.icons.length;i++){var _5=this.icons[i];if(!this.$16f(_5)||this.$16e(_5))continue;if(_3==false){_3=true;_2.append(this.$80b)}
_2.append("<td>");var _6=_1&&this.$54o(_5,true);_2.append(this.getIconHTML(_5,null,this.iconIsDisabled(_5),!!_6));_2.append("</td>")}
if(_3)_2.append("</table>");return _2.release()}
...
,isc.A.getIconPrompt=function isc_FormItem_getIconPrompt(_1){return _1.prompt||this.iconPrompt}
...
,isc.A.show=function isc_FormItem_show(_1){this.visible=true;if(!_1)this.showIf=null;if(this.containerWidget.redrawFormItem)this.containerWidget.redrawFormItem(this,"showing form item");else this.containerWidget.markForRedraw("showing form item");this.visibilityChanged(true)}
,isc.A.hide=function isc_FormItem_hide(_1){this.visible=false;if(!_1)this.showIf=null;if(this.containerWidget.redrawFormItem)this.containerWidget.redrawFormItem(this,"hiding form item");else this.containerWidget.markForRedraw("hiding form item");this.visibilityChanged(true)}
...
,isc.A.$17c=function isc_FormItem__formatDataType(_1){if(this.applyStaticTypeFormat){if(this.formatValue!=null){var _2=this.form,_3=this.form?this.form.values:{};return this.formatValue(_1,_3,_2,this)}}else if(this.formatEditorValue!=null){var _2=this.form,_3=this.form?this.form.values:{};return this.formatEditorValue(_1,_3,_2,this)}else if(this.$65!=null){var _2=this.form,_3=this.form?this.form.values:{};if(this.$62){return this.$62.editFormatter(_1,this,_2,_3)}else{return this.$65(_1,this,_2,_3)}}
...
,isc.A.getOptionDataSource=function isc_FormItem_getOptionDataSource(){var _1=this.optionDataSource;if(_1==null&&this.form.dataSource){if(this.foreignKey)_1=isc.DS.getForeignDSName(this,this.form.dataSource);else _1=this.form.dataSource}
...
,isc.A.setValue=function isc_FormItem_setValue(_1,_2){this.$17g=true;if(this.$751!=null&&!this.compareValues(_1,this._value)){this.$78w()}
var _3=(this.maintainSelectionOnTransform&&this.hasFocus&&(this.$17h()!=this.$14l));if(_3)this.rememberSelection();if(this.$17i!=null){isc.Timer.clearTimeout(this.$17i);this.$17i=null}
...
this.clearValue()}
,isc.A.$43f=function isc_FormItem__checkForDisplayFieldValue(_1){var _2=this.getOptionDataSource();if(_2&&(this.$78y==null||!this.compareValues(this.$78y,_1))&&(this.$63l==null||!this.$63l[_1]))
{if(!this.$63l)this.$63l={};this.$63l[_1]=true;var _3=this.optionCriteria||{};if(!this.filterLocally){_3[this.getValueFieldName()]=_1}
var _4=isc.addProperties({},this.optionFilterContext,{showPrompt:false,clientContext:{dataValue:_1}});var _5;if(this.optionOperationId!==_5){_4.operationId=this.optionOperationId}
_2.fetchData(_3,{target:this,methodName:"fetchMissingValueReply"},_4)}}
,isc.A.fetchMissingValueReply=function isc_FormItem_fetchMissingValueReply(_1,_2,_3){var _4,_5=_1.clientContext.dataValue,_6=this.getDisplayFieldName(),_7=this.getValueFieldName();delete this.$63l[_5];if(_2)_4=_2.find(_7,_5);if(!_4){this.logInfo("Unable to retrieve display value for data value:"+_5+" from dataSource "+this.getOptionDataSource());if(!this.filterLocally)return}
this.$78x(_4);if(this.$43d==null)this.$43d={};var _8=this.$43d;var _9;for(var i=0;i<_2.length;i++){_4=_2[i];var _11=_4[_7],_12=_4[_6];if(_8[_11]!==_9){if(_8[_11]!=_12){this.logWarn("Deriving valueMap for '"+_7+"' from dataSource based on displayField '"+_6+"'. This dataSource contains more than one record with "+_7+" set to "+_11+" with differing "+_6+" values."+" Derived valueMap is therefore unpredictable.")}
continue}
_8[_4[_7]]=_4[_6]}
if(this.filterLocally)this.$43e=true;var _13=(this._value==_5);this.updateValueMap(_13)}
,isc.A.getSelectedRecord=function isc_FormItem_getSelectedRecord(){if(this.$751&&(this.$78y==this._value)){return this.$751}}
,isc.A.$78x=function isc_FormItem__storeSelectedRecord(_1){this.$751=_1;this.$78y=this._value}
...
);isc.evalBoundary;isc.B.push(isc.A.setHint=function isc_FormItem_setHint(_1){this.hint=_1;if(this.showHint)this.redraw()}
...
_1=this.mapDisplayToValue(_1);if(this.compareValues(_1,this._value)){return true}
...
,isc.A.hasAdvancedCriteria=function isc_FormItem_hasAdvancedCriteria(){return this.operator!=null}
,isc.A.getOperator=function isc_FormItem_getOperator(_1){if(this.operator){var _2=this.operator}else{if(this.valueMap||this.optionDataSource||isc.SimpleType.inheritsFrom(this.type,"enum")||isc.SimpleType.inheritsFrom(this.type,"boolean"))
...
{return true}
return false}
,isc.A.getCriterion=function isc_FormItem_getCriterion(_1){var _2=this.getCriteriaValue();if(_2==null||isc.is.emptyString(_2))return;if(isc.isAn.Array(_2)){if(_2.length==0||_2.contains(isc.emptyString))return}
var _3=this.getOperator(_1);return{fieldName:this.getCriteriaFieldName(),operator:_3,value:_2}}
,isc.A.setCriterion=function isc_FormItem_setCriterion(_1){this.setValue(_1.value)}
...
,isc.A.validate=function isc_FormItem_validate(){var _1=this.hasErrors(),_2=[],_3=null,_4=false;var _5=this.getValue(),_6=isc.addProperties({},this.form.getValues()),_7={unknownErrorMessage:this.form.unknownErrorMessage};var _8=this.form.validateFieldAndDependencies(this,this.validators,_5,_6,_7);var _9=this.name;if(_9==null)_9=this.getDataPath();if(_9==null){this.logWarn("item has no specified name or dataPath - "+"unable to meaningfully store validation errors.")}
if(_8!=null){if(_8.resultingValue!=null){this.setValue(_8.resultingValue)}
if(!_8.valid){_2=_8.errors[_9];if(_2==null)_2=[]}
_4=_8.stopOnError;_3=_8.errors}
var _10=false;if(_2.length>0||_1){if(_2.length>0){this.form.setFieldErrors(_9,_2,false)}else{this.form.clearFieldErrors(_9,false)}
_10=true;if(_4)this.focusInItem()}
for(var _11 in _3){if(_11!=_9){var _12=_3[_11];if((_12!=null&&!isc.isAn.emptyObject(_12))||this.form.hasFieldErrors(_11))
{this.form.setFieldErrors(_11,_12,false);_10=true}}}
if(_10){this.redraw()}
return(_2.length==0)}
...
this.redraw()}
,isc.A.addValidator=function isc_FormItem_addValidator(_1){if(this.validators==null)this.validators=[];else if(!isc.isAn.Array(this.validators))this.validators=[this.validators];this.validators.add(_1)}
,isc.A.removeValidator=function isc_FormItem_removeValidator(_1){if(this.validators==null)return;if(!isc.isAn.Array(this.validators))this.validators=[this.validators];var _2=this.validators.find(_1);this.validators.remove(_2)}
...
var _9=isc.addProperties({},this.form.values),_10={unknownErrorMessage:this.form.unknownErrorMessage,changing:true},_11=this.form.validateFieldAndDependencies(this,this.validators,_1,_9,_10);if(_11!=null){_5=!_11.valid;if(_11.resultingValue!=null){_8=_11.resultingValue}
...
return true}
,isc.A.$11s=function isc_FormItem__moveFocusWithinItem(_1){var _2=this.items,_3=this.icons;if((_2==null||_2.length==0)&&(_3==null||_3.length==0)){return false}
...
return false}}
,isc.A.getFocusIconIndex=function isc_FormItem_getFocusIconIndex(){var _1=this.$166();if(_1==null||this.icons==null)return null;for(var i=0;i<this.icons.length;i++){if(this.$16g(this.icons[i])==_1)return i}
return null}
...
,isc.A.handleEditorExit=function isc_FormItem_handleEditorExit(){if(!this.$178)return;this.$178=null;var _1=this.getValue();if(this.validateOnExit||this.form.validateOnExit){if(!this.compareValues(_1,this.$75h))this.validate();this.$75h=null}
if((this.implicitSave||this.form.implicitSave)&&this.awaitingImplicitSave){this.form.performImplicitSave(this,false)}
...
,isc.A.$43g=function isc_FormItem__handleInput(){isc.EH.$h1("INP");if(this.changeOnKeypress&&!this.mask){if(isc.Log.supportsOnError){this.updateValue()}else{try{this.updateValue()}catch(e){isc.Log.$am(e)}}}
isc.EH.$h2()}
...
);isc.evalBoundary;isc.B.push(isc.A.$18d=function isc_FormItem__fireKeyPressHandlers(_1,_2,_3,_4){if(this.keyPress!=null&&this.keyPress(_1,_2,_3,_4)==false){return false}
...
_2.resultingValue=_9}else{delete _2.resultingValue;_6=_8(_1,_2,_3,_5)}}else{this.logWarn("validator not understood on item: "+this.echo(_1)+":\r"+isc.echoFull(_2))}
return _6}
...
isc.A=isc.ContainerItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$18u=isc.Canvas.$42a;isc.B.push(isc.A.init=function isc_ContainerItem_init(){this.Super("init",arguments);this.setItems(this.items?this.items:null)}
...
,isc.A.getTitleHTML=function isc_ContainerItem_getTitleHTML(){var _1=this.getTitle();if(this.accessKey!=null){_1=isc.Canvas.hiliteCharacter(_1,this.accessKey)}
return _1}
...
);isc.B._maxIndex=isc.C+25;isc.ClassFactory.defineClass("CanvasItem","FormItem");isc.A=isc.CanvasItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.width="*";isc.A.height=null;isc.A.shouldSaveValue=false;isc.B.push(isc.A.$18v=function isc_CanvasItem__canvas_resized(_1,_2,_3){this.Super("resized",arguments);if(!this.dragResizing()){this.canvasItem.canvasResized(_1,_2,_3)}}
...
);isc.B._maxIndex=isc.C+3;isc.A=isc.CanvasItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.init=function isc_CanvasItem_init(){this.Super("init",arguments);this.$18y()}
...
,isc.A.$18y=function isc_CanvasItem__createCanvas(){if(this.createCanvas!=null){this.canvas=this.fireCallback("createCanvas")}
...
,isc.A.setCanvas=function isc_CanvasItem_setCanvas(_1){if(_1)this.canvas=_1;this.$18y()}
...
,isc.A.focusInItem=function isc_CanvasItem_focusInItem(){if(this.canvas)this.canvas.focus();return this.Super("focusInItem",arguments)}
...
,isc.A.$12x=function isc_TextItem__nativeElementBlur(_1,_2){var _3=this.Super("$12x",arguments);if(this.changeOnBlur)this.form.elementChanged(this);else{var _4=this.getElementValue();if(this.mapDisplayToValue){_4=this.mapDisplayToValue(_4)}
...
,isc.A.mapDisplayToValue=function isc_TextItem_mapDisplayToValue(_1){if(this.mask){var _2=this.$716(_1)}else{_2=this.$17d(_1)}
_2=this.$79d(_2);if(isc.is.emptyString(_2))_2=this.$185;return _2}
...
,isc.A.$12v=function isc_TextItem__nativeElementFocus(_1,_2){var _3=this.Super("$12v",arguments);this.$66s();if(this.mask){this.$717(false);var _4=0;var _5=this.$718;if(!this.selectOnFocus){_4=this.$719();_5=_4}
...
,isc.A.keyPress=function isc_TextItem_keyPress(_1,_2,_3,_4){if(isc.EventHandler.ctrlKeyDown()||isc.EventHandler.altKeyDown())return true;if((!this.characterCasing||this.characterCasing==isc.TextItem.DEFAULT)&&!this.$66y&&!this.mask)
{return true}
...
this.$718++}
,isc.A.$72c=function isc_TextItem__getSelection(){var _1=this.getSelectionRange();return{begin:_1[0],end:_1[1]}}
...
return _4}
,isc.A.$715=function isc_TextItem__getMaskBuffer(){return this.$72l.join('')}
...
,isc.A.itemClick=function isc_PickListMenu_itemClick(_1){var _2=this.formItem,_3=_2.getValueFieldName();if(this.allowMultiSelect){var _4=this.getSelection();var _5=[];for(var i=0;i<_4.length;i++){var _7=_4[i];_5.add(_7[_3])}
_2.pickValue(_5)}else{var _8=_1[_3];_2.pickValue(_8)}}
,isc.A.hide=function isc_PickListMenu_hide(_1,_2,_3,_4){this.invokeSuper(isc.PickListMenu,"hide",_1,_2,_3,_4);if(!this.formItem)return;if(this.showModal)this.formItem.focusInItem();this.formItem.$19g=null;this.formItem.$19h();delete this.formItem.$19i}
...
,isc.A.$315=function isc_PickListMenu__formatCellValue(_1,_2,_3,_4,_5){var _6=this.getFieldName(_5);_1=this.formItem.formatPickListValue(_1,_6,_2);return this.Super("$315",[_1,_2,_3,_4,_5])}
...
if(!this.pickList){var _6=this.pickListProperties||{};if(this.sortField!=null)_6.sortField=this.sortField;if(this.sortFieldNum!=null)_6.sortFieldNum=this.sortFieldNum;if(this.sortDirection!=null)_6.sortDirection=this.sortDirection;this.pickList=isc.PickListMenu.create({headerHeight:this.pickListHeaderHeight},_6);var _7=this.pickList.dataProperties||{};if(this.filterLocally)_7.fetchMode="local";this.pickList.dataProperties=_7;if(_5)this.storeSharedPickList()}
...
var _4=this.pickList&&!this.pickList.destroyed?this.pickList.data:null;if(!_4||!(_4.localData||_4.allRows))return;var _5=(_2?this.getValueFieldName():this.getDisplayFieldName()),_6=(_2?this.getDisplayFieldName():this.getValueFieldName());if(_5==_6)return _1;var _7=_4.allRows||_4.localData;var _8;if(isc.isAn.Array(_1)){_8="";var _9=isc.shallowClone(_1);for(var i=0;i<_1.length;i++){var _11=_9[i];var _12=_7.find(_6,_1[i]);if(_12!=null)_8+=_12[_5];else continue;if(i!=_1.length-1)_8+=this.multipleValueSeparator}}else{var _12=_7.find(_6,_1);if(_12!=null)_8=_12[_5]}
return _8},$18q:"true",setUpPickListFields:function(){var _1=this.getPickListFields(),_2=this.pickList.fields;var _3=!_2||(_2.length!=_1.length);if(!_3){for(var i=0;i<_1.length;i++){var _5=_1[i],_6=_2[i];for(var _7 in _5){if(_5[_7]!=_6[_7]){_3=true;break}}
if(_3)break}}
...
return _1},getClientPickListData:function(){return isc.PickList.optionsFromValueMap(this)},$19h:function(){if(this.pickListHidden)this.pickListHidden()},$19j:function(){if(this.pickListShown)this.pickListShown()},selectDefaultItem:function(){return this.selectItemFromValue(this.getValue())},selectItemFromValue:function(_1){if(!isc.isAn.Array(_1))_1=[_1];var _2=this.pickList.getSelection(),_3=this.getValueFieldName(),_4=true,_5;for(var i=0;i<_1.length;i++){var _7=_1[i],_8;if(_2.find(_3,_7))continue;var _9=this.pickList.getData(),_10=this.$19m()?this.getOptionDataSource():null;if(_10!=null){var _11=_9.localData;if(_11)_8=_11.find(_3,_7)}else{_8=_9.find(_3,_7)}
...
var _2=this.getSelectedRecord();if(_2){var _3=this.mapValueToDisplay(_1);if(this.$19z!=_3&&!(!this.addUnknownValues&&this.isA("ComboBoxItem")))
{this.setElementValue(_3)}}}},filterDataBoundPickList:function(_1,_2){if(isc.$cv)arguments.$cw=this;var _3=this.getPickListFilterCriteria(),_4={textMatchStyle:this.textMatchStyle,showPrompt:false};if(this.optionFilterContext!=null)isc.addProperties(_4,this.optionFilterContext);if(this.optionOperationId!=null)_4.operationId=this.optionOperationId;if(_1!=null){isc.addProperties(_4,_1)}
...
if(!_5)_3=_1.duplicate();if(this.showAllOptions&&_4.length>1)_3.addList(_4);return _3},shouldHideEmptyPickList:function(){if(this.hideEmptyPickList!=null)return this.hideEmptyPickList;return!this.$19m()},getPickListPosition:function(){return[this.getPageLeft(),this.getPageTop()+this.getHeight()]},getPickListHeight:function(){var _1=this.pickListHeight,_2=this.pickList,_3=_2.getTotalRows();if(_3==0)return this.emptyPickListHeight;var _4=_2.cellHeight,_5=(_2.showHeader?_2.headerHeight:0),_6=_3*_4,_7=(_2.body?_2.body.getVBorderPad():isc.Element.$yo(_2.bodyStyleName)),_8=_6+_5+_2.getVBorderPad()+_7;if(_2.showFilterEditor){_8+=_2.filterEditorHeight}
return Math.min(_8,_1)},$19r:function(_1,_2,_3){var _4=this.pickList,_5=_1;if(_4.fixedFieldWidths){_4.resizeTo(_5,_2);return}
...
this.$19r(this.pickListWidth!=null?this.pickListWidth:this.getElementWidth(),_5,(_5==this.pickListHeight));if(this.allowPickListToClip)_1.setRect([_3,_4]);else _1.placeNear(_3,_4)},pickValue:function(_1){}});isc.A=isc.PickList;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.optionsFromValueMap=function isc_c_PickList_optionsFromValueMap(_1){var _2=_1.getValueMap(),_3=[];if(_2==null)_2=[];var _4=_1.getValueFieldName();if(isc.isAn.Array(_2)){for(var i=0;i<_2.length;i++){_3[i]={}
...
,isc.A.getClientPickListData=function isc_SelectItem_getClientPickListData(){if(this.$192)return this.$192;var _1=isc.PickList.optionsFromValueMap(this),_2=this.getValueFieldName();if(this.allowEmptyValue&&(_1.find(_2,null)==null)){var _3={};_1.addAt(_3,0)}
...
,isc.A.getPickListPosition=function isc_SelectItem_getPickListPosition(){var _1=this.getPageTop(),_2=_1+this.getHeight(),_3=this.getPageLeft(),_4=this.getPickListHeight(),_5=isc.Page.getScrollTop(),_6=isc.Page.getHeight()+_5;if(_2+_4>_6){_2=Math.max(_5,(_1-_4))}
return[_3,_2]}
,isc.A.setValueMap=function isc_SelectItem_setValueMap(){this.Super("setValueMap",arguments);if(this.$192)delete this.$192;if(this.hasPickList()){if(this.pickList.isVisible())this.pickList.hide();delete this.pickList.formItem}
...
,isc.A.filterComplete=function isc_SelectItem_filterComplete(){if(this.allowEmptyValue&&this.$19m()){var _1=this.pickList.data,_2=_1.isLocal()?_1.allRows:_1.localData;if(_2&&!_2.find(this.getValueFieldName(),null)){_1.insertCacheData({},0)}}
...
);isc.B._maxIndex=isc.C+8;isc.ClassFactory.defineClass("StaticTextItem","FormItem");isc.A=isc.StaticTextItem.getPrototype();isc.A.height=null;isc.A.width=null;isc.A.wrap=true;isc.A.textBoxStyle="staticTextItem";isc.A.redrawOnShowIcon=false;isc.A.outputAsHTML=false;isc.A.emptyDisplayValue="&nbsp;";isc.A=isc.StaticTextItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.mapValueToDisplay=function isc_StaticTextItem_mapValueToDisplay(_1,_2,_3,_4,_5){var _6=this.invokeSuper(isc.StaticTextItem,"mapValueToDisplay",_1,_2,_3,_4,_5);var _7=this.outputAsHTML||this.asHTML;if(_7&&(_1==null||_1==isc.emptyString)&&_6==this.$54t)
{_7=false}
if(isc.isA.String(_6)&&_7){_6=_6.asHTML()}
return _6}
,isc.A.isEditable=function isc_StaticTextItem_isEditable(){return false}
);isc.B._maxIndex=isc.C+2;isc.ClassFactory.defineClass("LinkItem","StaticTextItem");isc.A=isc.LinkItem.getPrototype();isc.A.wrap=false;isc.A.canFocus=true;isc.A=isc.LinkItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$14g=["<DIV ID='",,"' "+isc.DynamicForm.$89+"='",,"' "+isc.DynamicForm.$9a+"='"+isc.DynamicForm.$9c,"' CLASS='",,"' STYLE='",,"' onclick='if(window.",,") return ",,".$30i(event);","'>",,"</DIV>"];isc.B.push(isc.A.$15m=function isc_LinkItem__writeOutFocusProxy(){return false}
...
return false}
return true}
,isc.A.getElementHTML=function isc_LinkItem_getElementHTML(_1){var _2=this.getLinkHTML(_1);var _3=this.$14g;_3[1]=this.$15g();_3[3]=this.getID();_3[6]=this.getTextBoxStyle();_3[8]=this.getTextBoxCSS();_3[10]=this.getID();_3[12]=this.getID();_3[15]=_2;return _3.join(isc.emptyString)}
...
,isc.A.setValueDisabled=function isc_RadioGroupItem_setValueDisabled(_1,_2){var _3=this.itemForValue(_1);if(_3&&this.items.contains(_3)){_3.setDisabled(_2)}}
...
var _3=(isc.isA.Date(_1)&&isc.isA.Date(this._value)?(Date.compareLogicalDates(_1,this._value)==0):_1==this._value);var _4,_5;if(isc.is.emptyString(_1))_1=null;if(_1==null){_5=true;_4=null}else{_4=this.parseDate(_1);if(_4==null){_5=true;_4=_1}}
...
,isc.A.getStartDate=function isc_DateItem_getStartDate(){var _1=this.parseDate(this.startDate);if(!isc.isA.Date(_1)){this.logWarn("startDate was not in valid date format - using default start date");_1=isc.DateItem.DEFAULT_START_DATE}
return _1}
,isc.A.getEndDate=function isc_DateItem_getEndDate(){var _1=this.parseDate(this.endDate);if(!isc.isA.Date(_1)){this.logWarn("endDate was not in valid date format - using default end date");_1=isc.DateItem.DEFAULT_END_DATE}
return _1}
...
return _4}
,isc.A.parseDate=function isc_DateItem_parseDate(_1,_2){if(_2==null)_2=this.getInputFormat();var _3=Date.parseInput(_1,_2,this.centuryThreshold,true,this.useCustomTimezone);return _3}
,isc.A.formatDate=function isc_DateItem_formatDate(_1){return isc.isA.Date(_1)?_1.toShortDate(this.displayFormat,this.useCustomTimezone):_1}
...
return _6.release()}
,isc.A.$12v=function isc_TextAreaItem__nativeElementFocus(_1,_2){var _3=this.Super("$12v",arguments);this.$66s();return _3}
,isc.A.$12x=function isc_TextAreaItem__nativeElementBlur(_1,_2){var _3=this.Super("$12x",arguments);if(this.changeOnBlur)this.form.elementChanged(this);else{var _4=this.getElementValue();if(this.mapDisplayToValue){_4=this.mapDisplayToValue(_4)}
if(this._value!=_4)this.form.elementChanged(this)}
...
,isc.A.getElementCSSText=function isc_TextAreaItem_getElementCSSText(_1,_2){return isc.StringBuffer.concat((isc.Browser.isIE?"margin-top:-1px;margin-bottom:-1px;margin-left:0px;margin-right:0px;":"margin:0px;"),(isc.isA.Number(_1)?"WIDTH:"+_1+"px;":""),(isc.isA.Number(_2)?"HEIGHT:"+_2+"px;":""),(this.textAlign?"text-align:"+this.textAlign+";":""),(isc.Browser.isMoz?"-moz-user-focus:"+(this.$154()>0?"normal;":"ignore;"):""))}
...
return this.Super("handleKeyPress",arguments)}
,isc.A.handleKeyDown=function isc_ComboBoxItem_handleKeyDown(){if(!this.hasFocus)return this.Super("handleKeyDown",arguments);var _1=isc.EH.lastEvent.keyName,_2=this.pickList,_3=(_2?(_2.isDrawn()&&_2.isVisible()):false);if(_3){if(_2&&_2.isVisible()&&_1==this.$jf&&(this.completeOnTab||this.$17h()==this.$14l))
{var _4=_2.getSelectedRecord();if(_4!=null)_2.itemClick(_4)}}
return this.Super("handleKeyDown",arguments)}
,isc.A.handleEditorExit=function isc_ComboBoxItem_handleEditorExit(){if(this.addUnknownValues)return this.Super("handleEditorExit",arguments);var _1=this.getValue();if(_1==null){this.setElementValue("");return this.Super("handleEditorExit",arguments)}
var _2=this.mapValueToDisplay(_1);if(_2==_1){this.clearValue()}else{this.$10y(_1,true)}
this.Super("handleEditorExit",arguments)}
,isc.A.$10y=function isc_ComboBoxItem__updateValue(_1,_2){if(this.addUnknownValues||_2)return this.Super("$10y",arguments);var _3=this.getElementValue();if(_1==_3&&this.mapValueToDisplay(this.getValue())==_3){return}
var _4=this.mapValueToDisplay(_1);if(_4==_1){this.saveValue(null);this.refreshPickList(_1);return}
return this.Super("$10y",arguments)}
,isc.A.handleChange=function isc_ComboBoxItem_handleChange(_1,_2){var _3=this.Super("handleChange",arguments);if(_3==false)return false;this.refreshPickList(_1)}
,isc.A.refreshPickList=function isc_ComboBoxItem_refreshPickList(_1){_1=this.$17n||_1;var _2=(!_1||_1==isc.emptyString);if(!_2)delete this.$200;var _3=this.pickList,_4=(_3?_3.isVisible():false);if(_2&&!this.$200){if(_4)_3.hide()}else if(this.showPickListOnKeypress||_4){if(this.addUnknownValues)this.saveValue(_1);if(!this.$201&&this.hasFocus){this.filterWithValue=true;this.showPickList(true,true)}}}
...
,isc.A.getSelectedRecord=function isc_ComboBoxItem_getSelectedRecord(){var _1=this.Super("getSelectedRecord",arguments);if(_1==null&&this._value!=null&&this.getOptionDataSource()){if(this.pickList==null||this.pickList.destroyed)this.makePickList(false);if(this.pickList&&this.pickList.data){_1=this.pickList.data.find(this.getValueFieldName(),this._value);if(_1!=null)this.$78x(_1)}}
return _1}
,isc.A.getPickListFilterCriteria=function isc_ComboBoxItem_getPickListFilterCriteria(){var _1=this.optionCriteria||{};if(this.alwaysFilterWithValue||this.filterWithValue){var _2=this.addUnknownValues?this.getDisplayValue():this.getElementValue(),_3=(this.getDisplayFieldName()||this.getValueFieldName());_1[_3]=_2}
if(this.pickListCriteria)isc.addProperties(_1,this.pickListCriteria);return _1}
,isc.A.elementBlur=function isc_ComboBoxItem_elementBlur(){this.Super("elementBlur",arguments);var _1=this.pickList,_2=isc.EH,_3=_2.lastEvent;if((_1&&((_3.eventType=="selectionChange"&&_1.contains(isc.EH.mouseDownTarget()))||((_3.eventType==_2.MOUSE_DOWN||_3.eventType==_2.CLICK)&&_1.contains(_3.target,true))))||(isc.Browser.isIE&&this.getActiveElement()==this.getDataElement()))
{return}
delete this.$19i;delete this.$43i;if(!_1||!_1.isVisible()||_1.formItem!=this)return;_1.hide()}
...
{this.$66t()}}
,isc.A.showPicker=function isc_ComboBoxItem_showPicker(){this.focusInItem();this.filterWithValue=false;return this.showPickList()}
,isc.A.pickValue=function isc_ComboBoxItem_pickValue(_1){var _2=this.mapValueToDisplay(_1);if(this.addUnknownValues)this.setElementValue(_2);else this.setValue(_1);this.$201=true;this.$66x={};this.$66x[_2]=_1;this.updateValue();delete this.$201}
...
,isc.A.setValue=function isc_ComboBoxItem_setValue(_1,_2,_3,_4,_5){this.$43o=true;this.invokeSuper(isc.ComboBoxItem,"setValue",_1,_2,_3,_4,_5);delete this.$43o;if(!this.hasFocus&&this.showHint&&this.showHintInField&&this.getHint()){var _6;if(_1===_6||_1==null||isc.is.emptyString(_1)){this.$66t()}}}
...
return _1}
,isc.A.getCriteriaFieldName=function isc_ComboBoxItem_getCriteriaFieldName(){if(this.displayField&&!this.getSelectedRecord())return this.displayField;return this.criteriaField||this.getFieldName()}
,isc.A.$43f=function isc_ComboBoxItem__checkForDisplayFieldValue(_1,_2){var _3=(this.$17b(_1,true)!=null);if(_3)return;if(this.$43j){this.$43k=true;return}
this.invokeSuper(isc.ComboBoxItem,"$43f",_1)}
...
,isc.A.getIconsHTML=function isc_SpinnerItem_getIconsHTML(){if(!this.showIcons)return"";var _1=isc.SB.create();if(!this.$204){var _2="<TD tabIndex=-1"+(isc.Browser.isIE?" style='font-size:0px'":"")+">",_3={},_4=this.$16l(_3),_5=this.$16m(_3);this.$204=["<TABLE STYLE='vertical-align:",_4,";margin-top:",_5,";margin-bottom:",_5,";display:inline;' BORDER=0 CELLPADDING=0 CELLSPACING=0><TR>",_2,this.getIconHTML(this.icons[0]),"<TD></TR><TR>",_2,this.getIconHTML(this.icons[1]),"</TD></TR></TABLE>"]}else{this.$204[8]=this.getIconHTML(this.icons[0]);this.$204[11]=this.getIconHTML(this.icons[1])}
...
,isc.A.getEditorType=function isc_SearchForm_getEditorType(_1){var _2=_1.type;if(_2=="date")return"DateRangeItem";return this.Super("getEditorType",arguments)}
...
,isc.A.$10y=function isc_ValuesManager__updateValue(_1,_2,_3){if(isc.isA.DynamicForm(_3)&&_3.getItem(_1)==null){this.$66q(_3,_1);return}
...
,isc.A.getItem=function isc_ValuesManager_getItem(_1){return this.$706(_1,true)}
...
,isc.A.$706=function isc_ValuesManager__findMemberByField(_1,_2,_3){if(!this.members||_1==null||isc.isAn.emptyString(_1))return null;_1=_1.trim("/");var _4=_1.split(isc.Canvas.$70l);var _5=_3?[]:null;for(var i=0;i<this.members.length;i++){var _7=this.members[i],_8=_7.getFullDataPath();if(_8==isc.Canvas.$70l||isc.isAn.emptyString(_8))
...
,isc.A.setErrors=function isc_ValuesManager_setErrors(_1,_2){this.clearHiddenErrors();_1=isc.DynamicForm.formatValidationErrors(_1);var _3=(this.members?this.members.duplicate():[]);for(var i=0;i<_3.length;i++){if(!isc.isA.DynamicForm(_3[i]))continue;var _5=_3[i],_6=!_5.isVisible()||!_5.isDrawn(),_7=_5.getItems(),_8={},_9={};for(var j=0;j<_7.getLength();j++){var _11=_7[j],_12=_11.getFieldName();if(_1[_12]!=null){_8[_12]=_1[_12];if(_6||!_11.visible){_9[_12]=_1[_12]}
delete _1[_12]}}
...
,isc.A.$708=function isc_ValuesManager__cloneValues(_1,_2,_3){var _4="__ref";for(var _5 in _2){if(isc.isA.Function(_2[_5]))continue;if(_5==_4)continue;var _6=_5;if(_3){_6=_3+_5}else{_6=_5}
...
this.setValues(_1)}
,isc.A.valuesHaveChanged=function isc_ValuesManager_valuesHaveChanged(){return!isc.objectsAreEqual(this.getValues(),this.$10s)}
,isc.A.getValue=function isc_ValuesManager_getValue(_1){return isc.DynamicForm.$70o(_1,this.values)}
,isc.A.setValue=function isc_ValuesManager_setValue(_1,_2){var _3=false,_4,_5;if(this.members){var _6=this.getItem(_1);_4=_6&&_6.form?_6.form:this.getMemberForField(_1);if(_6&&_6.setValue){if(_2===_5)_6.clearValue();else _6.setValue(_2);_3=true}}
...
,isc.A.addMember=function isc_ValuesManager_addMember(_1,_2){if(isc.isA.String(_1))_1=window[_1];if(!isc.isA.Canvas(_1)){this.logWarn("addMember() passed invalid object: "+this.echo(_1)+" - this should be a DynamicForm instance");return}
if(_1.valuesManager!=null)_1.valuesManager.removeMember(_1);var _3=_1.getDataSource();if(_3!=null&&!_2&&_3!=this.getDataSource()){this.logWarn("addMember(): mismatched DataSources; new member form "+_1+" has dataSource: '"+_3.ID+"', valuesManager has DataSource "+(this.getDataSource()!=null?"'"+this.getDataSource().ID+"'":"[NONE]"))}
...
,isc.A.removeMember=function isc_ValuesManager_removeMember(_1){if(isc.isA.String(_1)){_1=isc.Class.getArrayItem(_1,this.members);if(_1==null)return}else if(!this.members.contains(_1))return;this.members.remove(_1);delete _1.valuesManager}
...
);isc.B._maxIndex=isc.C+63;isc.ValuesManager.registerStringMethods({handleHiddenValidationErrors:"errors",submitValues:"values,valuesManager"});if(isc.Window){isc.ClassFactory.defineClass("ColorPicker",isc.Window);isc.A=isc.ColorPicker;isc.A.MORE_BUTTON_TITLE="More >>";isc.A.LESS_BUTTON_TITLE="<< Less";isc.A=isc.ColorPicker;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getSharedColorPicker=function isc_c_ColorPicker_getSharedColorPicker(_1,_2){if(!isc.isA.ColorPicker(this.$56b)){this.$56b=isc.ColorPicker.create(_1)}else{if(_1.colorSelected==null)delete this.$56b.colorSelected;if(_1.colorChanged==null)delete this.$56b.colorChanged;this.$56b.setProperties(_1)}
...
,isc.A.initComplexElements=function isc_ColorPicker_initComplexElements(){this.$56x.setValue(this.$56q);this.$56h();this.$563(this.$56o,this.$56p);this.$56u.setBackgroundColor(isc.ColorUtils.hslToHtml(this.$56o,this.$56p,this.$56q));if(this.supportsTransparency){this.$56u.setOpacity(this.$56d);this.$56y.setValue(this.$56d)}}
...
if(this.form.saveProperties){this.form.saveProperties(this.dataPathProps,this.form.currentComponent)}}
);isc.B._maxIndex=isc.C+9;if(isc.ListGrid){isc.defineClass("RelativeDateItem","CanvasItem");isc.A=isc.RelativeDateItem;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.mapRelativeDateShortcut=function isc_c_RelativeDateItem_mapRelativeDateShortcut(_1){switch(_1){case"$now":return"+0MS";case"$today":case"$startOfToday":return"-0D";case"$endOfToday":return"+0D";case"$yesterday":case"$startOfYesterday":return"-1D";case"$endOfYesterday":return"-1ms[-0D]";case"$tomorrow":case"$startOfTomorrow":return"+1ms[D]";case"$endOfTomorrow":return"+1D";case"$startOfWeek":return"-0W";case"$endOfWeek":return"+0W";case"$startOfMonth":return"-0M";case"$endOfMonth":return"+0M";case"$startOfYear":return"-0Y";case"$endOfYear":return"+0Y"}
return _1}
,isc.A.getAbsoluteDate=function isc_c_RelativeDateItem_getAbsoluteDate(_1,_2){var _3=isc.RelativeDateItem,_4=_1,_5=new Date();_4=_3.mapRelativeDateShortcut(_1);var _6=_3.getRelativeDateParts(_4);var _7;_2=_2||new Date();_5.setTime(_2.getTime());if(_6.qualifier){_6.qualifier=_6.qualifier.toUpperCase();var _8=_3.getRelativeDateParts(_6.qualifier);var _9=["S","MN","H","D","W","M","Q","Y"];if(_9.contains(_8.period)){_5=_3.dateAdd(_5,_8.period,_8.countValue,(_8.direction=="+"?1:-1))}else{isc.logWarn("Invalid date-offset qualifier provided: "+_8.period+".  Valid "+"options are: S, MN, H, D, W, M, Q and Y.")}}
_7=_3.dateAdd(_5,_6.period,_6.countValue,(_6.direction=="+"?1:-1));return _7}
,isc.A.getRelativeDateParts=function isc_c_RelativeDateItem_getRelativeDateParts(_1){var _2=_1,_3=_2.substring(0,1),_4=_2.indexOf("["),_5=(_4>0?_2.substring(_4):null),_6=(_5!=null?_2.substring(1,_4):_2.substring(1)),_7=parseInt(_6),_8=_6.replace(_7,"");return{direction:(_3=="+"||_3=="-"?_3:"+"),qualifier:_5?_5.replace("[","").replace("]","").replace(",",""):null,countValue:isc.isA.Number(_7)?_7:0,period:_8?_8:_3}}
,isc.A.isRelativeDate=function isc_c_RelativeDateItem_isRelativeDate(_1){if(isc.isA.Date(_1))return false;if(isc.isAn.Object(_1)&&_1._constructor=="RelativeDate")return true;return false}
,isc.A.getPeriodName=function isc_c_RelativeDateItem_getPeriodName(_1){var _2=_1.toLowerCase();switch(_2){case"ms":return"Millisecond";case"s":return"Second";case"mn":return"Minute";case"h":return"Hour";case"d":return"Day";case"w":return"Week";case"m":return"Month";case"q":return"Quarter";case"y":return"Year";case"dc":return"Decade";case"c":return"Century"}}
,isc.A.dateAdd=function isc_c_RelativeDateItem_dateAdd(_1,_2,_3,_4){var _5=isc.RelativeDateItem,_6=_1;switch(_2){case"MS":case"ms":_6.setMilliseconds(_1.getMilliseconds()+(_3*_4));break;case"S":case"s":_6.setSeconds(_1.getSeconds()+(_3*_4));if(_2=="S"){_6=_5.getEndOf(_6,"S");break}
break;case"MN":case"mn":_6.setMinutes(_1.getMinutes()+(_3*_4));if(_2=="MN"){_6=_5.getEndOf(_6,"MN");break}
break;case"H":case"h":_6.setHours(_1.getHours()+(_3*_4));if(_2=="H"){_6=_5.getEndOf(_6,"H");break}
break;case"D":case"d":_6.setDate(_1.getDate()+(_3*_4));if(_2=="D"){switch(_4){case 1:_6=_5.getEndOf(_6,"D");break;case-1:_6=_5.getStartOf(_6,"D");break}}
break;case"W":case"w":_6.setDate(_1.getDate()+((_3*7)*_4));if(_2=="W"){_6=_5.getEndOf(_6,"W")}
break;case"M":case"m":_6.setMonth(_1.getMonth()+(_3*_4));if(_2=="M"){_6=_5.getEndOf(_6,"M")}
break;case"Q":case"q":_6.setMonth(_1.getMonth()+((_3*3)*_4));if(_2=="Q"){_6=_5.getEndOf(_6,"Q")}
break;case"Y":case"y":_6.setFullYear(_1.getFullYear()+(_3*_4));if(_2=="Y"){_6=_5.getEndOf(_6,"Y")}
break;case"DC":case"dc":_6.setFullYear(_1.getFullYear()+((_3*10)*_4));if(_2=="DC"){_6=_5.getEndOf(_6,"DC")}
break;case"C":case"c":_6.setFullYear(_1.getFullYear()+((_3*100)*_4));if(_2=="C"){_6=_5.getEndOf(_6,"C")}
break}
return _6}
,isc.A.getStartOf=function isc_c_RelativeDateItem_getStartOf(_1,_2){var _3=_1;switch(_2){case"s":case"S":return new Date(_3.getFullYear(),_3.getMonth(),_3.getDate(),_3.getHours(),_3.getMinutes(),_3.getSeconds(),0);case"mn":case"MN":return new Date(_3.getFullYear(),_3.getMonth(),_3.getDate(),_3.getHours(),_3.getMinutes(),0,0);case"h":case"H":return new Date(_3.getFullYear(),_3.getMonth(),_3.getDate(),_3.getHours(),0,0,0);case"d":case"D":return new Date(_3.getFullYear(),_3.getMonth(),_3.getDate(),0,0,0,0);case"w":case"W":_3.setDate(_1.getDate()-_1.getDay());return new Date(_3.getFullYear(),_3.getMonth(),_3.getDate(),0,0,0,0);case"m":case"M":return new Date(_1.getFullYear(),_1.getMonth(),1,0,0,0,0);case"q":case"Q":var _4=Math.floor((_1.getMonth+1)/3)*3;return new Date(_1.getFullYear(),_4-1,1,0,0,0,0);case"y":case"Y":return new Date(_1.getFullYear(),0,1,0,0,0,0);case"dc":case"DC":var _5=Math.floor(_1.getFullYear()/10)*10;return new Date(_5,0,1,0,0,0,0);case"c":case"C":var _6=Math.floor(_1.getFullYear()/100)*100;return new Date(_6,0,1,0,0,0,0)}
return _3}
,isc.A.getEndOf=function isc_c_RelativeDateItem_getEndOf(_1,_2){var _3=_1;switch(_2){case"s":case"S":return new Date(_3.getFullYear(),_3.getMonth(),_3.getDate(),_3.getHours(),_3.getMinutes(),_3.getSeconds(),999);case"mn":case"MN":return new Date(_3.getFullYear(),_3.getMonth(),_3.getDate(),_3.getHours(),_3.getMinutes(),59,999);case"h":case"H":return new Date(_3.getFullYear(),_3.getMonth(),_3.getDate(),_3.getHours(),59,59,999);case"d":case"D":return new Date(_1.getFullYear(),_1.getMonth(),_1.getDate(),23,59,59,999);case"w":case"W":_3.setDate(_1.getDate()+(6-_1.getDay()));return new Date(_3.getFullYear(),_3.getMonth(),_3.getDate(),23,59,59,999);case"m":case"M":_3=new Date(_1.getFullYear(),_1.getMonth()+1,1,23,59,59,999);_3.setDate(_3.getDate()-1);return _3;case"q":case"Q":var _4=Math.floor((_1.getMonth()+4)/3)*3;_3=new Date(_1.getFullYear(),_4,1,23,59,59,999);_3.setDate(_3.getDate()-1);return _3;case"y":case"Y":return new Date(_1.getFullYear(),11,31,23,59,59,999);case"dc":case"DC":var _5=((_1.getFullYear()/10)*10)+9;return new Date(_5,11,1,23,59,59,999);case"c":case"C":var _6=(Math.floor(_1.getFullYear()/100)*100)+99;return new Date(_6,11,1,23,59,59,999)}
return _3}
);isc.B._maxIndex=isc.C+8;isc.A=isc.RelativeDateItem.getPrototype();isc.A.height=20;isc.A.cellHeight=20;isc.A.canFocus=true;isc.A.timeUnitOptions=["day","week","month"];isc.A.todayTitle="Today";isc.A.millisecondsAgoTitle="N milliseconds ago";isc.A.secondsAgoTitle="N seconds ago";isc.A.minutesAgoTitle="N minutes ago";isc.A.hoursAgoTitle="N hours ago";isc.A.daysAgoTitle="N days ago";isc.A.weeksAgoTitle="N weeks ago";isc.A.monthsAgoTitle="N months ago";isc.A.yearsAgoTitle="N years ago";isc.A.millisecondsFromNowTitle="N milliseconds from now";isc.A.secondsFromNowTitle="N seconds from now";isc.A.minutesFromNowTitle="N minutes from now";isc.A.hoursFromNowTitle="N hours from now";isc.A.daysFromNowTitle="N days from now";isc.A.weeksFromNowTitle="N weeks from now";isc.A.monthsFromNowTitle="N months from now";isc.A.yearsFromNowTitle="N years from now";isc.A.defaultValue="$today";isc.A.operator="greaterThan";isc.A.presetOptions={"$today":"Today","$yesterday":"Yesterday","$tomorrow":"Tomorrow","-1w":"Current day of last week","+1w":"Current day of next week","-1m":"Current day of last month","+1m":"Current day of next month"};isc.A.valueFieldDefaults={type:"ComboBoxItem",name:"valueField",showTitle:false,shouldSaveValue:false,validateOnChange:false};isc.A.defaultQuantity=1;isc.A.quantityFieldDefaults={type:"SpinnerItem",name:"quantityField",width:60,min:0,step:1,showTitle:false,shouldSaveValue:false,selectOnFocus:true};isc.A.showChooserIcon=true;isc.A.pickerIconDefaults={name:"chooserIcon",showOver:false,showFocused:false,showFocusedWithItem:false,neverDisable:true,src:"[SKIN]/DynamicForm/DatePicker_icon.gif"};isc.A.pickerIconPrompt="Show Date Chooser";isc.A.pickerConstructor="DateChooser";isc.A.showCalculatedDateField=true;isc.A.calculatedDateFieldDefaults={type:"BlurbItem",name:"calculatedDateField",border:"1px solid black;",width:"*",startRow:false,showTitle:false,shouldSaveValue:false};isc.A.startDate=isc.DateItem.DEFAULT_START_DATE;isc.A.endDate=isc.DateItem.DEFAULT_END_DATE;isc.A.centuryThreshold=isc.DateItem.DEFAULT_CENTURY_THRESHOLD;isc.A.shouldSaveValue=true;isc.A.editorConstructor="DynamicForm";isc.A.editorDefaults={numCols:4,width:290,colWidths:[130,"*","*"],itemChanged:function(_1,_2){this.creator.updateValue(this.creator.getValue())}};isc.A.useSharedPicker=false;isc.A.pickerDefaults={width:isc.DateItem.chooserWidth,height:isc.DateItem.chooserHeight,showCancelButton:true,autoHide:true};isc.A=isc.RelativeDateItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.init=function isc_RelativeDateItem_init(){this.$67h();this.Super("init",arguments)}
,isc.A.isEditable=function isc_RelativeDateItem_isEditable(){return true}
,isc.A.$67h=function isc_RelativeDateItem__createEditor(){var _1;var _2={$76z:true};this.addAutoChild("editor",_2);this.canvas=this.editor;var _3=this,_4=[],_5=2;_4[0]=isc.addProperties({},this.valueFieldDefaults,this.valueFieldProperties,{valueMap:this.getValueFieldOptions(),changed:function(_6,_7,_8){_3.delayCall("valueFieldChanged",[_8],1)}});_4[1]=isc.addProperties({},this.quantityFieldDefaults,this.quantityFieldProperties,{defaultValue:this.defaultQuantity,changed:function(_6,_7,_8){_3.quantityFieldChanged(_8)}});if(this.showChooserIcon){_5=3;_4[2]={name:"iconPlaceholder",type:"staticText",width:1,showTitle:false,icons:[isc.addProperties({prompt:this.pickerIconPrompt},this.pickerIconDefaults,this.pickerIconProperties,{click:function(){_3.showPicker()}})]}}
...
this.setValue(this.defaultValue)}
,isc.A.valueFieldChanged=function isc_RelativeDateItem_valueFieldChanged(_1,_2){var _3=this.valueField.getSelectionRange();this.fieldChanged();if(_3)this.valueField.delayCall("setSelectionRange",[_3[0],_3[1]]);if(!_2&&this.quantityField.isVisible())this.quantityField.delayCall("focusInItem")}
,isc.A.quantityFieldChanged=function isc_RelativeDateItem_quantityFieldChanged(_1){this.fieldChanged()}
,isc.A.fieldChanged=function isc_RelativeDateItem_fieldChanged(){if(!this.valueField||!this.quantityField)return;var _1=this.valueField.getValue(),_2=this.quantityField.getValue();var _3=(_1&&isc.isA.String(_1)&&this.relativePresets[_1]);if(!_3){this.quantityField.hide()}else{this.quantityField.show()}
if(this.calculatedDateField){var _1=this.getValue();this.calculatedDateField.setValue(!_1?"":"("+this.formatDate(_1)+")")}}
,isc.A.getValueFieldOptions=function isc_RelativeDateItem_getValueFieldOptions(){var _1=isc.clone(this.presetOptions);this.relativePresets={};for(var i=0;i<this.timeUnitOptions.length;i++){var _3=this.timeUnitOptions[i];_1[_3+"_ago"]=this[_3+"sAgoTitle"];_1[_3+"_fromNow"]=this[_3+"sFromNowTitle"];this.relativePresets[_3+"_ago"]=true;this.relativePresets[_3+"_fromNow"]=true}
return _1}
,isc.A.setValue=function isc_RelativeDateItem_setValue(_1){if(_1==null){this.valueField.setValue(null);this.valueFieldChanged(_1,true);return}
if(isc.isA.Date(_1)||this.valueField.valueMap[_1]||(_1.value&&this.valueField.valueMap[_1.value]))
{this.valueField.setValue(isc.isA.Date(_1)?this.formatDate(_1):_1.value?_1.value:_1);this.valueFieldChanged(_1,true);return}
if(this.timeUnitOptions.contains(_1)){_1+="_fromNow";this.valueField.setValue(_1);this.valueFieldChanged(_1,true);return}
if(_1!=null){if(!isc.RelativeDateItem.isRelativeDate(_1)){}else{var _2,_3;if(isc.isAn.Object(_1)&&_1.value){var _4=isc.RelativeDateItem.getRelativeDateParts(_1.value),_5=isc.RelativeDateItem.getPeriodName(_4.period),_6=(_4.direction=="+"?"fromNow":"ago");_3=_4.countValue;_2=_5?_5.toLowerCase()+"_"+_6:null}
if(_2&&this.valueField.valueMap[_2]){this.valueField.setValue(_2);this.quantityField.setValue(_3)}else{}
this.valueFieldChanged(_1,true)}}}
,isc.A.getValue=function isc_RelativeDateItem_getValue(){if(!this.valueField||!this.quantityField)return;var _1=this.getRelativeDate();if(_1)
return isc.RelativeDateItem.getAbsoluteDate(_1.value,this.baseDate);var _2=this.valueField.getValue(),_3=this.parseDate(_2,this.getInputFormat());if(isc.isA.Date(_3))return _3;return null}
...
var _4=_1.indexOf("_");if(_4>=0){var _5=_1.substring(0,_4),_6=(_1.substring(_4+1)=="ago"?"-":"+"),_7;switch(_5){case"millisecond":_7="ms";break;case"second":_7="s";break;case"minute":_7="mn";break;case"hour":_7="h";break;case"day":_7="d";break;case"week":_7="w";break;case"month":_7="m";break;case"quarter":_7="q";break;case"year":_7="y";break;case"decade":_7="dc";break;case"century":_7="c";break;default:_7=null}
if(_7){_1=_6+_2+_7;return this.getRelativeDateObject(_1)}}
return null}
,isc.A.getRelativeDateObject=function isc_RelativeDateItem_getRelativeDateObject(_1){return{_constructor:"RelativeDate",value:_1}}
,isc.A.updateValue=function isc_RelativeDateItem_updateValue(_1){var _2=this.valueField.getValue();this.$10y(_1);this.$20l=true;this.valueField.setValue(_2);this.valueFieldChanged();this.$20l=false}
,isc.A.getCriteriaValue=function isc_RelativeDateItem_getCriteriaValue(){return this.getRelativeDate()}
,isc.A.getCriterion=function isc_RelativeDateItem_getCriterion(_1){var _2=this.valueField.getValue();if(_1==null&&isc.RelativeDateItem.isRelativeDate(_2))_1=false;var _3=(_1?this.getValue():this.getRelativeDate());return{operator:this.operator,value:_3}}
...
(_3/ 2));_2+=Math.round((this.getPickerIconHeight()/2)-(_4/ 2));return[_1,_2]}
,isc.A.pickerDataChanged=function isc_RelativeDateItem_pickerDataChanged(_1){var _2=_1.getData();var _3=_2.getFullYear(),_4=_2.getMonth(),_5=_2.getDate();this.$20l=true;this.valueField.setValue(this.formatDate(_2));this.$20l=false;this.updateValue();this.fieldChanged();if(!this.hasFocus)this.focusInItem()}
...
,isc.A.formatDate=function isc_RelativeDateItem_formatDate(_1){return isc.isA.Date(_1)?_1.toShortDate(this.displayFormat,this.useCustomTimezone):_1}
,isc.A.getInputFormat=function isc_RelativeDateItem_getInputFormat(){if(this.inputFormat)return this.inputFormat;if(this.displayFormat){return Date.mapDisplayFormatToInputFormat(this.displayFormat)}
return null}
...
,isc.A.hasAdvancedCriteria=function isc_DateRangeItem_hasAdvancedCriteria(){return true}
,isc.A.getCriterion=function isc_DateRangeItem_getCriterion(_1){_1=_1||!this.allowRelativeDates;var _2=_1?this.fromField.getValue():this.fromField.getRelativeDate()||this.fromField.getValue(),_3=_2!=null,_4=_1?this.toField.getValue():this.toField.getRelativeDate()||this.toField.getValue(),_5=_4!=null,_6=null;if(_3||_5){_6={_constructor:"AdvancedCriteria",operator:"and",criteria:[]};if(_3){_6.criteria.add({fieldName:this.name,operator:"greaterOrEqual",value:_2})}
if(_5){_6.criteria.add({fieldName:this.name,operator:"lessOrEqual",value:_4})}}
return _6}
...
return true}
return false}
,isc.A.setCriterion=function isc_DateRangeItem_setCriterion(_1){var _2,_3;if(_1.operator=="and"){_2=_1.criteria.find("operator","greaterThan");if(!_2)_2=_1.criteria.find("operator","greaterOrEqual");_3=_1.criteria.find("operator","lessThan");if(!_3)_3=_1.criteria.find("operator","lessOrEqual")}else{if(_1.operator=="greaterThan")_2=_1;else if(_1.operator=="greaterOrEqual")_2=_1;else if(_1.operator=="lessThan")_3=_1;else if(_1.operator=="lessOrEqual")_3=_1}
...
if(this.form&&this.form.showComplexFieldsRecursively){_2.showComplexFields=true;_2.showComplexFieldsRecursively=true}else{_2.showComplexFields=false}
_2.height=22;this.addAutoChild("dateRangeForm",_2);this.canvas=this.dateRangeForm;this.baseDate=this.baseDate||new Date();var _4=this,_5=this.allowRelativeDates?"RelativeDateItem":"DateItem",_6=[];_6[0]=isc.addProperties({},this.fromFieldDefaults,this.fromFieldProperties,{name:"fromField",_constructor:_5,baseDate:this.baseDate,displayformat:this.dateDisplayFormat,inputFormat:this.dateInputFormat,title:this.fromTitle,titleOrientation:this.form.titleOrientation,defaultValue:this.fromValue,useTextField:(_5=="DateItem"?true:null)});_6[1]=isc.addProperties({},this.toFieldDefaults,this.toFieldProperties,{name:"toField",_constructor:_5,baseDate:this.baseDate,displayformat:this.dateDisplayFormat,inputFormat:this.dateInputFormat,title:this.toTitle,titleOrientation:this.form.titleOrientation,defaultValue:this.toValue,useTextField:(_5=="DateItem"?true:null)});this.canvas.setFields(_6);this.toField=this.canvas.getField("toField");this.fromField=this.canvas.getField("fromField");if(this.allowRelativeDates){this.fromField.canvas.$v4=this.toField.canvas;this.toField.canvas.$vw=this.fromField.canvas}
...
);isc.B._maxIndex=isc.C+5;isc.defineClass("MiniDateRangeItem","StaticTextItem");isc.A=isc.MiniDateRangeItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.textBoxStyle="textItem";isc.A.clipValue=true;isc.A.wrap=false;isc.A.iconVAlign="top";isc.A.height=20;isc.A.width=100;isc.A.shouldSaveValue=true;isc.A.rangeDialogDefaults={_constructor:"DateRangeDialog",autoDraw:false,destroyOnClose:false};isc.A.fromDateOnlyPrefix="Since";isc.A.toDateOnlyPrefix="Before";isc.A.pickerIconPrompt="Show Date Chooser";isc.A.pickerIconDefaults={name:"showDateRange",src:"[SKIN]/DynamicForm/DatePicker_icon.gif",width:20,height:20,neverDisable:true,showDisabled:false,showOver:false,showFocused:false,showFocusedWithItem:false,hspace:0,click:function(_1,_2,_3){_2.showRangeDialog()}};isc.A.allowRelativeDates=true;isc.B.push(isc.A.handleClick=function isc_MiniDateRangeItem_handleClick(){this.showRangeDialog()}
);isc.B._maxIndex=isc.C+1;isc.A=isc.MiniDateRangeItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.init=function isc_MiniDateRangeItem_init(){this.addAutoChild("rangeDialog",{fromDate:this.fromDate,toDate:this.toDate,rangeItemProperties:{allowRelativeDates:this.allowRelativeDates},dateDisplayFormat:this.dateDisplayFormat,callback:this.getID()+".rangeDialogCallback(value)"});this.icons=[isc.addProperties({prompt:this.pickerIconPrompt},this.pickerIconDefaults,this.pickerIconProperties)];this.rangeItem=this.rangeDialog.rangeItem;this.rangeItem.name=this.name}
...
,isc.A.hasAdvancedCriteria=function isc_MiniDateRangeItem_hasAdvancedCriteria(){return true}
...
,isc.A.updateValue=function isc_MiniDateRangeItem_updateValue(_1){if(!this.$10y(_1))return;this.updateStoredDates(_1);this.displayValue(_1)}
,isc.A.mapValueToDisplay=function isc_MiniDateRangeItem_mapValueToDisplay(_1){if(_1==null)return"";var _2=_1.start,_3=_1.end,_4=isc.RelativeDateItem,_5=(_4.isRelativeDate(_2)?_4.getAbsoluteDate(_2.value):_2),_6=(_4.isRelativeDate(_3)?_4.getAbsoluteDate(_3.value):_3);var _7;if(_5||_6){if(this.dateDisplayFormat){if(_5)_7=this.formatDate(_5);if(_6){if(_7)_7+=" - "+this.formatDate(_6);else _7=this.formatDate(_6)}}else _7=Date.getFormattedDateRangeString(_5,_6);if(!_5)_7=this.toDateOnlyPrefix+" "+_7;else if(!_6)_7=this.fromDateOnlyPrefix+" "+_7}
