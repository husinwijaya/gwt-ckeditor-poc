...
,isc.A.getNearestSchemaClass=function isc_c_DataSource_getNearestSchemaClass(_1){if(_1==null)return null;var _2;while(_2==null){var _1=isc.DS.get(_1);_2=isc.ClassFactory.getClass(_1._constructor||_1.Constructor||_1.type);if(_2!=null)return _2;_1=_1.inheritsFrom;if(!_1)return null}
return null}
...
,isc.A.filterCriteriaForFormValues=function isc_c_DataSource_filterCriteriaForFormValues(_1){var _2={};for(var _3 in _1){var _4=_1[_3];if(_4==null||isc.is.emptyString(_4))continue;if(isc.isAn.Array(_4)){if(_4.length==0)continue;for(var i=0;i<_4.length;i++){var _6=_4[i];if(isc.isAn.emptyString(_6))continue}}
_2[_3]=_4}
return _2}
...
return false}
,isc.A.getCriteriaFields=function isc_c_DataSource_getCriteriaFields(_1,_2){if(_2&&!isc.isA.DataSource(_2))_2=this.get(_2);if(_2?_2.isAdvancedCriteria(_1):this.isAdvancedCriteria(_1))
{var _3=[];this.$74s(_1,_3);return _3}
...
this.cacheData=this.testData=_1;if(this.logIsInfoEnabled("cacheAllData")){this.logInfo("setCacheData: cacheData has been set","cacheAllData")}}}
...
return _4}
,isc.A.serializeFields=function isc_DataSource_serializeFields(_1,_2){if(!_1)_1=_2.data;if(!_1)return _1;if(isc.DS.isSimpleTypeValue(_1))return _1;if(isc.isAn.Array(_1)){var _3=[];for(var i=0;i<_1.length;i++){_3[i]=this.serializeFields(_1[i],_2)}
...
_5=this.convertRelativeDates(_5);if(this.logIsInfoEnabled("relativeDates")){this.logInfo("Called convertRelativeDates from getServiceInputs "+"- data is\n\n"+isc.echoFull(_5))}
_1.data=_5}
var _6=this.getDataProtocol(_1),_7=_6=="clientCustom";if(_7){return{dataProtocol:"clientCustom"}}else{delete this.$624[_1.requestId]}
...
var _8=this.getDataURL(_1);_8=_1.actionURL||_1.dataURL||_8;if(_1.useHttpProxy==null){_1.useHttpProxy=this.$du(_2.useHttpProxy,this.useHttpProxy)}
var _9,_10=_2.defaultParams||this.defaultParams,_11=_1.params;if(_10||_11){_9=isc.addProperties({},_10,_11)}
...
if(_6=="postXML"||_6=="soap"){var _14=this.getSerializeFlags(_1);var _15=_13.data=this.getXMLRequestBody(_1);_13.contentType=_1.contentType||"text/xml";this.logDebug("XML post requestBody is: "+_15,"xmlBinding")}
if(_6=="soap"){var _16=this.$du(_2.soapAction,_4.soapAction);if(_16==null)_16='""';_13.httpHeaders=isc.addProperties({SOAPAction:_16},_1.httpHeaders);var _17=isc.isA.WebService(_3)&&this.$du(_2.spoofResponses,this.spoofResponses);if(_17){_13.spoofedResponse=_3.getSampleResponse(_4.name);this.logInfo("Using spoofed response:\n"+_13.spoofedResponse,"xmlBinding")}}
if(this.logIsDebugEnabled("xmlBinding")){this.logDebug("serviceInputs are: "+this.echo(_13),"xmlBinding")}
return _13}
,isc.A.addDefaultCriteria=function isc_DataSource_addDefaultCriteria(_1,_2){var _3=_2.defaultCriteria||this.defaultCriteria;_3=isc.addProperties({},_3);if(_3&&_1.operationType=="fetch"){if(this.isAdvancedCriteria(_1.data)){var _4=this.mineCriteriaFieldNames(_1.data);for(var _5 in _3){if(_4.contains(_5))delete _3[_5]}}
_1.data=isc.DataSource.combineCriteria(_1.data,_3,"and",null,true)}}
...
this.$38b(_4,_2,_3)}
,isc.A.$50e=function isc_DataSource__handleClientOnlyReply(_1,_2,_3){var _4=this.cacheAllData&&!this.clientOnly&&this.cacheResultSet?this.cacheResultSet.getAllRows():null,_5=this.getClientOnlyResponse(_3.$374,_4),_6=_3.$374;this.$38b(_2,_5,_6,_1,_3)}
,isc.A.$38a=function isc_DataSource__handleCustomReply(_1,_2,_3){var _4={data:_2,startRow:0,endRow:0,totalRows:0,status:0};var _5=_3.$374;this.$38b(_2,_4,_5,_1,_3)}
,isc.A.$377=function isc_DataSource__handleJSONReply(_1,_2,_3){var _4=_3.$374,_5=this.getOperationBinding(_4).recordXPath||this.recordXPath;if((_1.$38c||_1.$69j)&&this.logIsDebugEnabled("xmlBinding")){this.logDebug("Raw response data: "+this.echoFull(_2),"xmlBinding")}
...
,isc.A.$378=function isc_DataSource__handleXMLReply(_1,_2,_3,_4){var _5=_1,_6=_4.$374,_7=this.getOperationBinding(_6),_8;if(_3.status<0){var _9=_2||_3.data;this.$38b(_9,{status:_3.status,data:_9},_6,_3,_4);return}
...
_2.endRow=this.$52v(_7);_2.totalRows=this.$52v(_2.totalRows,_2.endRow);if(this.useOfflineStorage&&_2.status==0){isc.DataSource.cacheResponse(_3,_2);if(isc.Offline){isc.Offline.storeResponse(_3,_2)}}
if(_3&&_3.resultSet){if(_2.status==isc.RPCResponse.STATUS_OFFLINE){_3.resultSet.$78c=true}else{_3.resultSet.$78c=false}}
...
);isc.evalBoundary;isc.B.push(isc.A.getFieldValue=function isc_DataSource_getFieldValue(_1,_2,_3){var _4=isc.xml.getFieldValue(_1,_2,_3,this,this.xmlNamespaces);if(!_3.getFieldValue)return _4;if(!isc.isA.Function(_3.getFieldValue)){isc.Func.replaceWithMethod(_3,"getFieldValue","record,value,field,fieldName")}
...
,isc.A.exportClientData=function isc_DataSource_exportClientData(_1,_2){var _3=_2,_4=_3&&_3.exportAs?_3.exportAs:"csv",_5=_3&&_3.exportFilename?_3.exportFilename:"export",_6=_3&&_3.exportDisplay?_3.exportDisplay:"download";var _7={showPrompt:false,transport:"hiddenFrame",exportResults:true,downloadResult:true,downloadToNewWindow:(_6=="window"),download_filename:(_6=="window"?_5:null)};isc.DMI.callBuiltin({methodName:"downloadClientExport",arguments:[_1,_4,_5,_6],requestParams:_7})}
...
if(_2.textMatchStyle==null)_2.textMatchStyle="substring";var _3={};_3.exportResults=true;_3.exportAs=_2.exportAs||"csv";_3.exportDelimiter=_2.exportDelimiter||",";_3.exportTitleSeparatorChar=_2.exportTitleSeparatorChar||"";_3.exportFilename=_2.exportFilename||"Results."+(_3.exportAs=="ooxml"?"xlsx":_3.exportAs);_2.exportFilename=_3.exportFilename;_3.exportDisplay=_2.exportDisplay||"download";_3.lineBreakStyle=_2.lineBreakStyle||"default";_3.exportFields=this.getExportableDSFields(_2.exportFields||this.getVisibleDSFields());_3.exportHeader=_2.exportHeader;_3.exportFooter=_2.exportFooter;_2.downloadResult=true;_2.downloadToNewWindow=_2.exportDisplay=="window"?true:false;if(_2.downloadToNewWindow){if(_3.exportFilename.endsWith(".xml")&&_3.exportAs!="xml"){_3.exportFilename=_3.exportFilename+".txt"}
...
,isc.A.addData=function isc_DataSource_addData(_1,_2,_3){this.performDSOperation("add",_1,_2,_3)}
,isc.A.updateData=function isc_DataSource_updateData(_1,_2,_3){this.performDSOperation("update",_1,_2,_3)}
,isc.A.removeData=function isc_DataSource_removeData(_1,_2,_3){var _4=this.getPrimaryKeyFields(),_1=isc.applyMask(_1,_4);this.performDSOperation("remove",_1,_2,_3)}
...
if(!this.cacheAllData&&this.autoCacheAllData&&_1.operationType=="fetch"&&_1.startRow==null&&_1.endRow==null&&_1.criteria==null)
...
if(_2=="iscServer"){this.$754(_1);var _4=this.transformRequest(_1);if(this.autoConvertRelativeDates==true){if(this.logIsInfoEnabled("relativeDates")){this.logInfo("Calling convertRelativeDates from sendDSRequest "+"- data is\n\n"+isc.echoFull(_4))}
_4=this.convertRelativeDates(_4);if(this.logIsInfoEnabled("relativeDates")){this.logInfo("Called convertRelativeDates from sendDSRequest "+"- data is\n\n"+isc.echoFull(_4))}
_1.data=_4}
var _5=this.getDataProtocol(_1);if(_5=="clientCustom")return;if((!this.clientOnly&&!this.cacheAllData)||(_1.cachingAllData||(this.cacheAllData&&_1.operationType&&_1.operationType!="fetch")))
...
this.addDefaultCriteria(_1,this.getOperationBinding(_1));this.applySendExtraFields(_1);var _6=this.getOperationBinding(_1);if(_6==null)_6={};var _7=_6.defaultParams||this.defaultParams;if(_7){_1.data=isc.addProperties({},_7,_1.data)}
_4=_1.data;return this.performSCServerOperation(_1,_4)}}
var _8=this.getServiceInputs(_1);if(_8.dataProtocol=="clientCustom")return;var _9=isc.addProperties({},_1,_8);_9.$374=_1;if(_8.data==null)_9.data=null;if(this.clientOnly||(this.cacheAllData&&_1.operationType=="fetch")){_9.clientOnly=true;_9.callback={target:this,methodName:"$50e"};isc.RPC.sendRequest(_9);return}
var _10=this.getOperationBinding(_1);_9.transport=_10.dataTransport||this.dataTransport;if(_9.transport=="scriptInclude"){_9.callback={target:this,methodName:"$377"};if(!_9.callbackParam){_9.callbackParam=_10.callbackParam||this.callbackParam}
...
,isc.A.fulfilledFromOffline=function isc_DataSource_fulfilledFromOffline(_1){if(this.useOfflineStorage&&isc.Offline){var _2=_1.dataSource+"."+_1.operationType;if(isc.Offline.isOffline()){var _3=isc.Offline.getResponse(_1);this.logInfo("currently offline, for request: "+_2+" found cached response: "+this.echoLeaf(_3),"offline");this.processOfflineResponse(_1,_3);return true}else if(_1.useOfflineCache||_1.useOfflineCacheOnly){var _3=isc.Offline.getResponse(_1);if(_3!=null){this.logInfo("request: "+_2+", returning cached offline response","offline");this.processOfflineResponse(_1,_3);return true}else if(_1.useOfflineCacheOnly){this.logInfo("request: "+_2+": useOfflineCacheOnly: no response available","offline");this.processOfflineResponse(_1);return true}
this.logInfo("request: "+_2+", no cached response, proceeding with network request","offline")}}
return false}
,isc.A.processOfflineResponse=function isc_DataSource_processOfflineResponse(_1,_2){if(!_2)_2={status:isc.RPCResponse.STATUS_OFFLINE,data:isc.DataSource.offlineMessage};_2.isCachedResponse=true;this.fireResponseCallbacks(_2,_1)}
...
,isc.A.getTitleField=function isc_DataSource_getTitleField(){if(this.titleField==null){var _1=isc.getKeys(this.getFields());this.titleField=_1.contains("title")?"title":_1.contains("label")?"label":_1.contains("name")?"name":_1.contains("id")?"id":_1.first()}
...
,isc.A.getField=function isc_DataSource_getField(_1){var _2=this.getFields();return _2?_2[_1]:null}
...
this.$498=[_1];this.cacheResultSet=isc.ResultSet.create({dataSource:this,fetchMode:"local",allRows:this.cacheData?this.cacheData:null,cachingAllData:true,dataArrived:function(_3,_4){if(this.logIsInfoEnabled("cacheAllData")){this.logInfo("cacheAllData - cacheResultSet.dataArrived: startRow/endRow: "+_3+"/"+_4)}
if(this.lengthIsKnown()){var _2=this.getDataSource();if(_2.cacheResultSet==null)return;_2.cacheLastFetchTime=new Date().getTime();if(_2.clientOnly)_2.testData=_2.cacheData=this.getAllRows();_2.processDeferredRequests()}}});if(!this.cacheData){if(this.logIsInfoEnabled("cacheAllData")){this.logInfo("firstCacheAllDataRequest: issuing fetch","cacheAllData")}
...
,isc.A.applyFilter=function isc_DataSource_applyFilter(_1,_2,_3){var _4=[];if(!_1||_1.length==0)return _4;var _5=_2;if(this.autoConvertRelativeDates==true){if(this.logIsInfoEnabled("relativeDates")){this.logInfo("Calling convertRelativeDates from applyFilter - data is\n\n"+isc.echoFull(_5))}
_5=this.convertRelativeDates(_5);if(this.logIsInfoEnabled("relativeDates")){this.logInfo("Called convertRelativeDates from applyFilter - data is\n\n"+isc.echoFull(_5))}}
if(this.isAdvancedCriteria(_5)){return this.recordsMatchingAdvancedFilter(_1,_5,_3)}
return this.recordsMatchingFilter(_1,_5,_3)}
...
);isc.evalBoundary;isc.B.push(isc.A.getTextMatchStyle=function isc_DataSource_getTextMatchStyle(_1){if(_1==null)_1=this.$50i;if(!this.supportsTextMatchStyle(_1)){_1=this.$19q}
return _1}
...
return 1}
return _7}
);isc.B._maxIndex=isc.C+158;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$628=0;isc.A.$71l={sum:function(_1,_2,_3){var _4=0;for(var i=0;i<_2.length;i++){var _6=_1[_2[i].name],_7=parseFloat(_6);if(isc.isA.Number(_7)&&_7==_6){_4+=_7}else{if(_6!=null&&_6!=isc.emptyString){return null}}}
...
return _3}
,isc.A.combineCriteria=function isc_c_DataSource_combineCriteria(_1,_2,_3,_4){if(!_1)return _2;if(!_2)return _1;if(!_3)_3="and";if(_3!="and"&&_3!="or"){isc.logWarn("combineCriteria called with invalid outerOperator '"+_3+"'");return null}
...
return _10}
,isc.A.simplifyAdvancedCriteria=function isc_c_DataSource_simplifyAdvancedCriteria(_1){if(!this.isAdvancedCriteria(_1)){return _1}
_1=this.$79a(_1);_1._constructor="AdvancedCriteria";return _1}
,isc.A.$79a=function isc_c_DataSource__simplifyAdvancedCriteria(_1){var _2=_1.operator;if(_2=="and"||_2=="or"){var _3=_1.criteria;if(_3==null||_3.length==0){return _1}
if(_3.length==1){_1=_3[0];return this.$79a(_1)}
var _4=[];for(var i=0;i<_3.length;i++){var _6=_3[i];_6=this.$79a(_6);if(_6.operator==_2){_4.addList(_6.criteria)}else{_4.add(_6)}}
_1.criteria=_4;return _1}else{return _1}}
...
return-1};var _58=function(_60,_61,_62){if(_60.value==_61.value&&_60.fieldName==_61.fieldName){return 0}else{return-1}};var _59=[{ID:"equals",titleProperty:"equalsTitle",negate:false,valueType:"fieldType",condition:_5,compareCriteria:_41,getCriterion:function(_60,_61){var _19={fieldName:_60,operator:this.ID};if(isc.isA.RelativeDateItem(_61))
_19.value=_61.getRelativeDate()||_61.getValue();else _19.value=_61.getValue();return _19}},{ID:"notEqual",titleProperty:"notEqualTitle",negate:true,valueType:"fieldType",condition:_5,compareCriteria:_41,getCriterion:function(_60,_61){var _19={fieldName:_60,operator:this.ID};if(isc.isA.RelativeDateItem(_61))
_19.value=_61.getRelativeDate()||_61.getValue();else _19.value=_61.getValue();return _19}},{ID:"greaterThan",titleProperty:"greaterThanTitle",lowerBounds:true,valueType:"fieldType",condition:_8,compareCriteria:_42,getCriterion:function(_60,_61){var _19={fieldName:_60,operator:this.ID};if(isc.isA.RelativeDateItem(_61))
_19.value=_61.getRelativeDate()||_61.getValue();else _19.value=_61.getValue();return _19}},{ID:"lessThan",titleProperty:"lessThanTitle",upperBounds:true,valueType:"fieldType",condition:_8,compareCriteria:_42,getCriterion:function(_60,_61){var _19={fieldName:_60,operator:this.ID};if(isc.isA.RelativeDateItem(_61))
_19.value=_61.getRelativeDate()||_61.getValue();else _19.value=_61.getValue();return _19}},{ID:"greaterOrEqual",titleProperty:"greaterOrEqualTitle",lowerBounds:true,inclusive:true,valueType:"fieldType",condition:_8,compareCriteria:_42,getCriterion:function(_60,_61){var _19={fieldName:_60,operator:this.ID};if(isc.isA.RelativeDateItem(_61))
_19.value=_61.getRelativeDate()||_61.getValue();else _19.value=_61.getValue();return _19}},{ID:"lessOrEqual",titleProperty:"lessOrEqualTitle",upperBounds:true,inclusive:true,valueType:"fieldType",condition:_8,compareCriteria:_42,getCriterion:function(_60,_61){var _19={fieldName:_60,operator:this.ID};if(isc.isA.RelativeDateItem(_61))
_19.value=_61.getRelativeDate()||_61.getValue();else _19.value=_61.getValue();return _19}},{ID:"between",titleProperty:"betweenTitle",lowerBounds:true,upperBounds:true,valueType:"valueRange",condition:_8,compareCriteria:_42,getCriterion:function(_60,_61){var _19={fieldName:_60,operator:this.ID};if(isc.isA.RelativeDateItem(_61))
_19.value=_61.getRelativeDate()||_61.getValue();else _19.value=_61.getValue();return _19}},{ID:"betweenInclusive",titleProperty:"betweenInclusiveTitle",lowerBounds:true,upperBounds:true,hidden:true,valueType:"valueRange",inclusive:true,condition:_8,compareCriteria:_42,getCriterion:function(_60,_61){var _19={fieldName:_60,operator:this.ID};if(isc.isA.RelativeDateItem(_61))
_19.value=_61.getRelativeDate()||_61.getValue();else _19.value=_61.getValue();return _19}},{ID:"iEquals",titleProperty:"iEqualsTitle",equals:true,caseInsensitive:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"iContains",titleProperty:"iContainsTitle",caseInsensitive:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"iStartsWith",titleProperty:"iStartsWithTitle",startsWith:true,caseInsensitive:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"iEndsWith",titleProperty:"iEndsWithTitle",endsWith:true,caseInsensitive:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"contains",titleProperty:"containsTitle",hidden:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"startsWith",titleProperty:"startsWithTitle",startsWith:true,hidden:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"endsWith",titleProperty:"endsWithTitle",endsWith:true,hidden:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"iNotEqual",titleProperty:"iNotEqualTitle",caseInsensitive:true,equals:true,negate:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"iNotContains",titleProperty:"iNotContainsTitle",caseInsensitive:true,negate:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"iNotStartsWith",titleProperty:"iNotStartsWithTitle",startsWith:true,caseInsensitive:true,negate:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"iNotEndsWith",titleProperty:"iNotEndsWithTitle",endsWith:true,caseInsensitive:true,negate:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"notContains",titleProperty:"notContainsTitle",negate:true,hidden:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"notStartsWith",titleProperty:"notStartsWithTitle",startsWith:true,negate:true,hidden:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"notEndsWith",titleProperty:"notEndsWithTitle",endsWith:true,negate:true,hidden:true,valueType:"fieldType",condition:_17,compareCriteria:_52},{ID:"isNull",titleProperty:"isNullTitle",valueType:"none",condition:_20,compareCriteria:_55},{ID:"notNull",titleProperty:"notNullTitle",negate:true,valueType:"none",condition:_20,compareCriteria:_55},{ID:"regexp",titleProperty:"regexpTitle",hidden:true,valueType:"custom",condition:_22,compareCriteria:_56},{ID:"iregexp",titleProperty:"iregexpTitle",hidden:true,caseInsensitive:true,valueType:"custom",condition:_22,compareCriteria:_56},{ID:"inSet",titleProperty:"inSetTitle",hidden:true,valueType:"valueSet",condition:_24,compareCriteria:_57},{ID:"notInSet",titleProperty:"notInSetTitle",negate:true,hidden:true,valueType:"valueSet",condition:_24,compareCriteria:_57},{ID:"equalsField",titleProperty:"equalsFieldTitle",valueType:"fieldName",condition:_27,compareCriteria:_58},{ID:"notEqualField",titleProperty:"notEqualFieldTitle",negate:true,valueType:"fieldName",condition:_27,compareCriteria:_58},{ID:"greaterThanField",titleProperty:"greaterThanFieldTitle",lowerBounds:true,valueType:"fieldName",condition:_29,compareCriteria:_58},{ID:"lessThanField",titleProperty:"lessThanFieldTitle",upperBounds:true,valueType:"fieldName",condition:_29,compareCriteria:_58},{ID:"greaterOrEqualField",titleProperty:"greaterOrEqualFieldTitle",lowerBounds:true,inclusive:true,valueType:"fieldName",condition:_29,compareCriteria:_58},{ID:"lessOrEqualField",titleProperty:"lessOrEqualFieldTitle",upperBounds:true,inclusive:true,valueType:"fieldName",condition:_29,compareCriteria:_58},{ID:"containsField",titleProperty:"containsFieldTitle",hidden:true,valueType:"fieldName",condition:_30,compareCriteria:_58},{ID:"startsWithField",titleProperty:"startsWithTitleField",startsWith:true,hidden:true,valueType:"fieldName",condition:_30,compareCriteria:_58},{ID:"endsWithField",titleProperty:"endsWithTitleField",endsWith:true,hidden:true,valueType:"fieldName",condition:_30,compareCriteria:_58},{ID:"and",titleProperty:"andTitle",isAnd:true,valueType:"criteria",condition:_1,compareCriteria:_31},{ID:"not",titleProperty:"notTitle",isNot:true,valueType:"criteria",condition:_1,compareCriteria:_31},{ID:"or",titleProperty:"orTitle",isOr:true,valueType:"criteria",condition:_1,compareCriteria:_31}];for(var _3=0;_3<_59.length;_3++){isc.DataSource.addSearchOperator(_59[_3])}
...
,isc.A.sendQueue=function isc_c_RPCManager_sendQueue(_1,_2,_3){var _4=this.currentTransaction;this.currentTransaction=null;this.queuing=false;if(!_4){this.logInfo("sendQueue called with no current queue, ignoring");return false}
var _5=_4.operations[0];if(!isc.Page.isLoaded()){_4.$76k={callback:_1,prompt:_2,URL:_3};if(!this.delayingTransactions)isc.Page.setEvent("load",this,isc.Page.FIRE_ONCE,"resendDelayedTransactions");this.delayingTransactions=true}
...
,isc.A.canSortOnClient=function isc_ResultSet_canSortOnClient(){return this.shouldUseClientSorting()&&(this.allMatchingRowsCached()||isc.isOffline())}
...
return _1}
,isc.A.getServerFilter=function isc_ResultSet_getServerFilter(){if(this.isLocal())return null;return this.criteria}
...
,isc.A.fetchRemoteData=function isc_ResultSet_fetchRemoteData(_1,_2,_3){if(isc.isOffline()){this.haveOfflineRecords=true;return}
...
if(this.cachingAllData)_5.cachingAllData=true;this.getDataSource().fetchData(_1,{caller:this,methodName:"fetchRemoteDataReply"},_5);if(!this.isPaged())this.$39v=this.$39r}
,isc.A.fetchRemoteDataReply=function isc_ResultSet_fetchRemoteDataReply(_1,_2,_3){var _4=_1.clientContext.requestIndex;if(!this.$39y)this.$39y=0;if(_4!=(this.$39y+1)&&!_1.isCachedResponse){this.logInfo("server returned out-of-sequence response for fetch remote data request "+" - delaying processing: last processed:"+this.$39y+", returned:"+_4);if(!this.$39z)this.$39z=[];this.$39z.add({dsResponse:_1,data:_2,request:_3});return}
if(this.cachingAllData==true)delete this.cachingAllData;if(!this.isPaged()&&this.$39v==_4)delete this.$39v;var _5;if(_1.status<0||_1.offlineResponse){_5=[]}else{_5=_1.data}
...
,isc.A.$522=function isc_ResultSet__doneDataArriving(_1,_2){if(--this.$523==0){if(this.dataArrived)this.dataArrived(_1,_2)}}
...
if(_2==null)_2={};var _5=this.getSaveOperationType(_2);if(!_2.oldValues){_2.oldValues=_5!="add"?this.$10s:{}}
if(this.validationURL&&!_3){var _6={};isc.addProperties(_6,_2);isc.addProperties(_6,{actionURL:this.validationURL,valuesAsParams:true,sendNoQueue:true});_6.$40b=_2;_6.$40c=_1;this.performingServerValidation=true;this.validateData(this.getID()+".$40d(rpcRequest,rpcResponse,data)",_6);return}
var _7=this.getFileItemForm();if(_7&&_7.isDrawn()){this.updateFileItemForm();if(!this.validate())return false;return _7.saveData(_1,_2,_3)}
this.$40c=_1;_1=this.getID()+".$49z(dsRequest, dsResponse, data)";_2=this.buildRequest(_2,_5,_1);var _8=false;if(this.submitParamsOnly)_2.useSimpleHttp=true;if(isc.DynamicForm&&isc.isA.DynamicForm(this)){if(this.$66g){_2.actionURL=this.action;_2.target=this.target?this.target:window;_8=true}
...
if(work.sort)work.sort();else this.sort(work);var counter=0;for(j=0;j<work.length;j++){counter++;if(work[j]==counter)continue;while(work[j]!=counter&&counter<=9999){this.unusedAttributeNumbers[i].push(counter++)}}
...
if(!this.contextMenu)this.contextMenu=isc.Menu.create({});this.contextMenu.setData(_2);this.contextMenu.showContextMenu(_1);return false},standardMenuItems:[{title:"Remove",click:"target.destroy()"},{title:"Bring to Front",click:"target.bringToFront()"},{title:"Send to Back",click:"target.sendToBack()"}],multiSelectionMenuItems:[{title:"Remove Selected Items",click:"target.editContext.removeSelection(target)"}]};isc.A.useEditMask=true;isc.A.dropMargin=15;isc.B.push(isc.A.setEditMode=function isc_Canvas_setEditMode(_1,_2,_3){if(_1==null)_1=true;if(this.editingOn==_1)return;this.editingOn=_1;if(this.editingOn){this.editContext=_2}else{this.hideEditMask()}
...
,isc.A.completeItemDrop=function isc_Canvas_completeItemDrop(_1){var _2=_1.className||_1.type;var _3=isc.ClassFactory.getClass(_2);if(_3&&isc.isA.FormItem(_3)){this.editContext.addWithWrapper(_1,this.editNode)}else{this.editContext.addComponent(_1,this.editNode)}}
...
return _4}
);isc.B._maxIndex=isc.C+18;isc.A=isc.Class.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getSchema=function isc_Class_getSchema(){return isc.DS.get(this.schemaName||this.Class)}
...
,isc.A.$40k=function isc_Class__doVerbToChild(_1,_2,_3,_4,_5){var _6=_5||this.getObjectField(_2);var _7=this.getSchemaField(_6);if(!_7.multiple){var _8={};_8[_6]=_3;this.logInfo(_1+"ChildObject calling setProperties for fieldName '"+_6+"'","editing");this.setProperties(_8);return true}
...
return false}
,isc.A.getChildObject=function isc_Class_getChildObject(_1,_2,_3){var _4=_3||this.getObjectField(_1),_5=this.getSchemaField(_4);if(!_5.multiple)return this.getProperty(_4);var _6;if(isc.isA.ListGrid(this)&&_4=="fields"){_6="getSpecifiedField"}else{_6=this.getFieldMethod(_1,_4,"get")}
...
,isc.A.saveToOriginalValues=function isc_Class_saveToOriginalValues(_1){var _2;if(!this.editModeOriginalValues)this.editModeOriginalValues={};for(var i=0;i<_1.length;i++){var _4=isc.isAn.Object(_1[i])?_1[i].name:_1[i];if(this[_4]===_2){this.editModeOriginalValues[_4]=null}else{this.editModeOriginalValues[_4]=this[_4]}}}
...
);isc.B._maxIndex=isc.C+14;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getSchema=function isc_c_DataSource_getSchema(_1){if(isc.isA.Class(_1))return _1.getSchema();return isc.DS.get(_1.schemaName||_1._constructor||_1.Class)}
...
isc.A=isc.Layout.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.setEditMode=function isc_Layout_setEditMode(_1,_2,_3){if(_1==null)_1=true;if(_1==this.editingOn)return;this.invokeSuper(isc.Layout,"setEditMode",_1,_2,_3);var _4=this.className||this.type,_5=isc.DS.getNearestSchema(_4),_6=_5.getField("members"),_7=true;if(!_6||!_6.inapplicable){_6=_5.getField("children");if(!_6||!_6.inapplicable){_7=false}}
...
,isc.A.editModeDrop=function isc_Layout_editModeDrop(){if(this.shouldPassDropThrough()){this.hideDropLine();return}
...
,isc.A.setEditorType=function isc_DynamicForm_setEditorType(_1,_2){var _3=_1.editContext.data,_4=_3.getParent(_1.editNode),_5=_3.getChildren(_4).indexOf(_1.editNode),_6=_1.editContext,_7={className:_2,defaults:_1.editNode.defaults},_8=_6.makeEditNode(_7);_6.removeComponent(_1.editNode);_6.addComponent(_8,_4,_5)}
...
,isc.A.editModeSetNoDropIndicator=function isc_ListGrid_editModeSetNoDropIndicator(){this.invokeSuper(isc.ListGrid,"setNoDropIndicator");this.body.editModeSetNoDropIndicator()}
...
,isc.A.positionDragHandle=function isc_c_EditContext_positionDragHandle(_1){if(!this.$70r)return;var _2=this.draggingObject;if(_2.destroyed||_2.destroying){this.logWarn("target of dragHandle: "+isc.echoLeft(_2)+" is invalid: "+_2.destroyed?"already destroyed":"currently in destroy()");return}
...
if(_1.initData.ID!=null)_1.ID=_1.initData.ID;if(_3.setEditableProperties){_3.setEditableProperties(_2);if(_3.markForRedraw)_3.markForRedraw();else if(_3.redraw)_3.redraw()}else{isc.addProperties(_3,_2);var _6=this.data.getParent(_1);if(_6&&_6.liveObject&&_6.liveObject.markForRedraw)
...
return _4}
,isc.A.saveCoordinates=function isc_EditPane_saveCoordinates(_1){if(!this.editComponents)return;var _2=this.editComponents.find("liveObject",_1);if(!_2)return;_2.initData=isc.addProperties(_2.initData,{left:_1.getLeft(),top:_1.getTop(),width:_1.getWidth(),height:_1.getHeight()})}
...
,isc.A.serializeEditNodes=function isc_EditTree_serializeEditNodes(_1,_2){var _3=isc.SB.create();this.serverless=_2;for(var i=0;i<_1.length;i++){var _5=_1[i]=isc.addProperties({},_1[i]),_6=isc.ClassFactory.getClass(_5.type),_7=_5.initData=isc.addProperties({},_5.initData);if(_6&&_6.isA("Canvas")&&_7&&_7.visibility!=isc.Canvas.HIDDEN&&_7.autoDraw!==false)
{_7.autoDraw=true}}
...
,isc.A.getLoadingMessage=function isc_ViewLoader_getLoadingMessage(){return this.loadingMessage.evalDynamicString(this,{loadingImage:this.imgHTML(isc.Canvas.loadingImageSrc,isc.Canvas.loadingImageSize,isc.Canvas.loadingImageSize)})}
...
if(_1!=null)this.contentsURL=_1;if(this.loadingMessage){var _4=this.loadingMessage.evalDynamicString(this,{loadingImage:this.imgHTML(isc.Canvas.loadingImageSrc,isc.Canvas.loadingImageSize,isc.Canvas.loadingImageSize)});this.setContents(_4)}
...
,isc.A.modifyContent=function isc_HTMLFlow_modifyContent(){this.$73w()}
...
,isc.A.setupClause=function isc_FilterClause_setupClause(){if(this.showRemoveButton)this.addAutoChild("removeButton");var _1={};if(this.showClause!=false){var _2=[isc.addProperties(isc.clone(this.fieldPickerDefaults),{width:this.fieldPickerWidth},this.fieldPickerProperties,{name:"fieldName"}),isc.addProperties(isc.clone(this.operatorPickerDefaults),{width:this.operatorPickerWidth},this.operatorPickerProperties,{name:"operator"})],_3=this.criterion,_4=this.getFieldNames(),_5;if(this.fieldName&&this.dataSource){var _6=this.fieldName;var _7=this.getField(_6),_8;isc.addProperties(_2[0],{type:"staticText",clipValue:true,wrap:false});if(!_7||(this.excludeNonFilterableFields&&_7.canFilter==false))_6=_4[0];else if(this.showFieldTitles){_8=_7.title?_7.title:_6}
_2[0].defaultValue=_8||_6;_5=_6}else{if(this.fieldDataSource){isc.addProperties(_2[0],{type:"ComboBoxItem",completeOnTab:true,optionDataSource:this.fieldDataSource,valueField:"name",displayField:this.showFieldTitles?"title":"name",pickListProperties:{reusePickList:function(){return false}}});if(this.field)_2[0].defaultValue=this.field.name}else{for(var i=0;i<_4.length;i++){var _10=_4[i],_7=this.getField(_10);if(_7.canFilter==false)continue;if(this.showFieldTitles){var _8=_7.title;_8=_8?_8:_10;_1[_10]=_8}else{_1[_10]=_10}}
_2[0].valueMap=_1;_2[0].defaultValue=isc.firstKey(_1)}}
this.fieldPicker=_2[0];var _11=_2[0],_12=_2[1];if(!this.fieldName){if(_3&&_3.fieldName){if(this.fieldDataSource){_11.defaultValue=_3.fieldName}else{if(_4.contains(_3.fieldName)){_11.defaultValue=_3.fieldName}else{isc.logWarn("Criterion specified field "+_3.fieldName+", which is not"+" in the record. Using the first record field ("+_1?isc.firstKey(_1):_4[0]+") instead");_11.defaultValue=_1?isc.firstKey(_1):_4[0]}}}
_5=_11.defaultValue}
if(_5){var _7=this.field||this.getField(_5);var _13=_7?this.getFieldOperatorMap(_7,false,"criteria",true):null;_12.valueMap=_13;if(_13){if(_3&&_3.operator){_12.defaultValue=_3.operator}else{_12.defaultValue=isc.firstKey(_13)}}
this.$74o=_5;var _14=this.getSearchOperator(_12.defaultValue);if(!_14&&_13.length>0){isc.logWarn("Criterion specified unknown operator "+(_3?_3.operator:"[null criterion]")+". Using the first valid operator ("+isc.firstKey(_13)+") instead");_12.defaultValue=isc.firstKey(_13);_14=this.getSearchOperator(_12.defaultValue)}
var _15=this.buildValueItemList(_7,_14);if(_3){if(_3.value!=null&&_15.containsProperty("name","value")){_15.find("name","value").defaultValue=_3.value}
if(_3.start!=null&&_15.containsProperty("name","start")){_15.find("name","start").defaultValue=_3.start}
if(_3.end!=null&&_15.containsProperty("name","end")){_15.find("name","end").defaultValue=_3.end}}
if(_15)_2.addList(_15)}else{_12.disabled=true}
this.addAutoChild("clause",{flattenItems:this.flattenItems,items:_2});this.fieldPicker=this.clause.getItem("fieldName");this.operatorPicker=this.clause.getItem("operator")}
this.addMembers([this.removeButton,this.clause]);if(this.fieldPicker&&this.fieldPicker.type=="staticText"){this.fieldPicker.prompt=this.fieldPicker.getValue()}}
...
if(_1.editorType=="SelectItem"||_1.editorType=="ComboBoxItem"){if(_1.editorProperties!=null){_7=_1.editorProperties;_9=isc.addProperties(_9,{optionDataSource:_7.optionDataSource?_7.optionDataSource:this.getDataSource(),valueField:_7.valueField?_7.valueField:_1.name,displayField:_7.displayField?_7.displayField:_1.name})}}else if(_1.editorProperties){_9=isc.addProperties({},_9,_1.editorProperties)}
...
,isc.A.getCriterion=function isc_FilterClause_getCriterion(){if(!this.clause)return null;var _1=this.clause,_2=this.getFieldName(),_3=this.operatorPicker.getValue(),_4=_1.getField("value"),_5=_1.getField("start"),_6=_1.getField("end"),_7=_1.getValues();if(isc.isA.String(_3))_3=this.getSearchOperator(_3);if(_3.getCriterion&&isc.isA.Function(_3.getCriterion)){if(_4){_7=_3.getCriterion(_2,_4)}else{var _8=_3.getCriterion(_2,_5),_9=_3.getCriterion(_2,_6);_7.fieldName=_8.fieldName;_7.operator=_8.operator;delete _7.value;_7.start=_8.value;_7.end=_9.value}}
if(this.fieldName)_7.fieldName=this.fieldName;if(isc.isA.Date(_7.value))_7.value.logicalDate=true;if(!_3||(_3.valueType!="none"&&_3.valueType!="valueRange"&&(_7.value==null||(isc.isA.String(_7.value)&&_7.value==""))))
{return null}
return _7}
...
,isc.A.removeClause=function isc_FilterBuilder_removeClause(_1){this.clauses.remove(_1);if(this.clauseStack)this.clauseStack.hideMember(_1,function(){_1.destroy()});this.updateFirstRemoveButton()}
...
,isc.A.addNewClause=function isc_FilterBuilder_addNewClause(_1,_2){var _3=this.createAutoChild("clause",{visibility:"hidden",flattenItems:true,criterion:_1,dataSource:this.dataSource,validateOnChange:this.validateOnChange,showFieldTitles:this.showFieldTitles,showRemoveButton:this.showRemoveButton,removeButtonPrompt:this.removeButtonPrompt,retainValuesAcrossFields:this.retainValuesAcrossFields,fieldDataSource:this.fieldDataSource,field:_2,fieldData:this.fieldData,fieldPickerDefaults:this.fieldPickerDefaults,fieldPickerProperties:this.fieldPickerProperties,remove:function(){this.creator.removeClause(this)},fieldNameChanged:function(){this.Super("fieldNameChanged",arguments);this.creator.fieldNameChanged(this)}});return this.$74e(_3)}
,isc.A.addClause=function isc_FilterBuilder_addClause(_1){if(!_1)return _1;var _2=this;_1.fieldDataSource=this.fieldDataSource;_1.remove=function(){_2.removeClause(this)};_1.fieldNameChanged=function(){this.Super("fieldNameChanged",arguments);_2.fieldNameChanged(this)};return this.$74e(_1)}
,isc.A.$74e=function isc_FilterBuilder__addClause(_1){this.clauses.add(_1);var _2=this.clauseStack;var _3=Math.max(0,_2.getMemberNumber(this.buttonBar));_2.addMember(_1,_3);_2.showMember(_1,function(){_1.setDefaultFocus()});this.updateFirstRemoveButton();return _1}
...
,isc.A.setCriteria=function isc_FilterBuilder_setCriteria(_1){this.clearCriteria(true);this.stripNullCriteria(_1);if(!this.$76t&&this.fieldDataSource&&_1){if(isc.isA.String(this.fieldDataSource))
this.fieldDataSource=isc.DS.getDataSource(this.fieldDataSource);var _2=this,_3=this.fieldDataSource.getCriteriaFields(_1),_4={};if(_3&&_3.length>0){_4={_constructor:"AdvancedCriteria",operator:"or",criteria:[]};for(i=0;i<_3.length;i++){var _5=_3[i],_6=this.fieldData?this.fieldData[_5]:null;if(!_6){_4.criteria[_4.criteria.length]={fieldName:"name",operator:"equals",value:_5}}}
if(_4.criteria.length!=0){this.$76t=true;this.fieldDataSource.fetchData(_4,function(_10){_2.fetchFieldsReply(_10,_1)});return}}}
...
{this.logWarn("Found top-level AdvancedCriteria with no sub-criteria. Converting "+"to a top-level 'and' with a single sub-criterion");this.setTopOperator(this.topOperator);this.addNewClause(_1)}else{for(var i=0;i<_1.criteria.length;i++){var _8=_1.criteria[i],_9=this.fieldData?this.fieldData[_8.fieldName]:null;this.addCriterion(_8,_9)}
if(this.clauses.length==0&&!this.allowEmpty)this.addNewClause()}
delete this.$75v;this.$76t=false;this.clauseStack.show();this.redraw();this.filterReady()}
...
if(_5)
return isc.FormItemFactory.getItemClassName({},_5.type,null);else
return isc.FormItemFactory.getItemClassName({},"text",null)}
);isc.B._maxIndex=isc.C+32;isc.FilterBuilder.registerStringMethods({search:"criteria",filterChanged:""})}
...
,isc.A.setWAIState=function isc_c_Canvas_setWAIState(_1,_2,_3){_1.setAttributeNS(this.waiStateNS,_2,_3)}
,isc.A.setWAIStates=function isc_c_Canvas_setWAIStates(_1,_2){for(var _3 in _2){this.setWAIState(_1,_3,_2[_3])}}
);isc.B._maxIndex=isc.C+3;if(isc.DynamicForm){isc.A=isc.FormItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.addContentRoles=function isc_FormItem_addContentRoles(){if(!isc.Browser.isMoz||isc.Browser.geckoVersion<20051111)return;if(!this.$kk())return;var _1=this.getFocusElement();if(_1!=null)isc.Canvas.setWAIRole(_1,this.waiRole)}
);isc.B._maxIndex=isc.C+1}
if(isc.GridRenderer){isc.A=isc.GridRenderer.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.addContentRoles=function isc_GridRenderer_addContentRoles(){if(!isc.Browser.isMoz||isc.Browser.geckoVersion<20051111)return;var _1=this.parentElement;if(!_1||(!_1.rowRole&&!_1.getRowRole))return;for(var i=this.$252;i<=this.$253;i++){var _3=i,_4=this.getTableElement(_3),_5=_1.getRowRole?_1.getRowRole(_3):_1.rowRole;if(_5&&_4){isc.Canvas.setWAIRole(_4,_5);if(_1.getRowWAIState){var _6=_1.getRowWAIState(_3);if(_6)isc.Canvas.setWAIStates(_4,_6)}}
this.addCellRoles(_3)}}
,isc.A.addCellRoles=function isc_GridRenderer_addCellRoles(_1){var _2=this.parentElement;if(!_2||(!_2.cellRole&&!_2.getCellRole))return;for(var i=this.$254;i<=this.$255;i++){var _4=this.getTableElement(_1,i),_5=_2.getCellRole?_2.getCellRole(_1,i):_2.cellRole;if(_5){isc.Canvas.setWAIRole(_4,_5);if(_2.getCellWAIState){var _6=_2.getCellWAIState(_1,i);if(_6)isc.Canvas.setWAIStates(_4,_6)}}}}
);isc.B._maxIndex=isc.C+2;isc.A=isc.ListGrid.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.waiRole="list";isc.A.rowRole="listitem";isc.B.push(isc.A.getRowRole=function isc_ListGrid_getRowRole(_1){var _2=this.getCellRecord(_1);if(_2&&_2.isSeparator)return"separator";return this.rowRole}
,isc.A.getRowWAIState=function isc_ListGrid_getRowWAIState(_1){var _2=this.getRecord(_1);if(this.selection&&this.selection.isSelected&&this.selection.isSelected(_1)){return{selected:true}}}
);isc.B._maxIndex=isc.C+2;isc.A=isc.TreeGrid.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.waiRole="tree";isc.A.rowRole="treeitem";isc.B.push(isc.A.getRowRole=function isc_TreeGrid_getRowRole(_1){if(!isc.isA.Tree(this.data)){return this.rowRole}
var _2=this.getRecord(_1);if(this.data.isFolder(_2))return"group";else return this.rowRole}
,isc.A.getRowWAIState=function isc_TreeGrid_getRowWAIState(_1){var _2=this.getRecord(_1),_3=this.data,_4=!!(this.selection&&this.selection.isSelected&&this.selection.isSelected(_2));if(!_4&&!_3.isFolder(_2))return;var _5={selected:_4};if(_3.isFolder(_2))_5.expanded=!!_3.isOpen(_2);return _5}
);isc.B._maxIndex=isc.C+2;isc.A=isc.Menu.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.waiRole="menu";isc.B.push(isc.A.getRowRole=function isc_Menu_getRowRole(_1){var _2=this.getItem(_1);if(!_2||_2.isSeparator)return"separator";if(_2.checked||_2.checkIf||_2.checkable)return"menuitemcheckable";if(_2.radio)return"menuitemradio";return"menuitem"}
...
(function(){var _1={Button:"button",StretchImgButton:"button",ImgButton:"button",Label:"label",SectionHeader:"heading",ImgSectionHeader:"heading",CheckboxItem:"checkbox",Slider:"slider",ComboBoxItem:"combobox",SelectItem:"listbox",Window:"dialog",Toolbar:"toolbar",TabBar:"tablist",PaneContainer:"tabpanel",ImgTab:"tab",EdgedCanvas:"presentation",BackMask:"presentation"}
...
,isc.A.initWidget=function isc_DataSourceEditor_initWidget(){this.Super('initWidget',arguments);this.addAutoChildren(["mainStack","fieldLayout","instructions","mainEditor","buttonLayout","saveButton"]);if(this.canAddChildSchema){this.canEditChildSchema=true;this.addAutoChild("addChildButton")}
